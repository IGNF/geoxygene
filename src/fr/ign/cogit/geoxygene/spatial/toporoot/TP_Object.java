 ...
 * On appelle id l'identifiant topologique qu'on retrouve dans la table
 * TP_Object du SGBD.
...
abstract public class TP_Object implements Cloneable {
    ...
    public int dimension() {
        ...
        System.out.println(
        "this n'est pas une primitive topologique. La fonction dimension renvoie -1."); //$NON-NLS-1$
        return -1;
    }
     ...
     * frontiere de self.
     * Si le TP_Object est associe a un GM_Object, sa frontiere doit etre
     * coherente en terme d'orientation avec celle du GM_Object.
     * Les TP_Boundary sont des TP_Expression et ont donc une forme polynomiale
    ...
    //////////////////////////////////////////////////////////////////////////
    /** Set de TP_Primitive constituant l'intrrieur de self (c'est-a-dire sans
     * la frontiere) dans le complexe maximal de l'objet.
     * Pour un TP_Primitive, le resultat sera self.
     * Pour un complexe, le resultat sera les primitives de ce complexe qui ne
     * sont pas sur la frontiere du complexe.
     * Le resultat est equivalent a l'interieur de la realisation geometrique
     * de self. */
    ...
    /** Set de TP_Primitive constituant exterieur de self dans le complexe
     * maximal de l'objet :
     * toutes les TP_Primitives du complexe maximal qui ne sont pas a
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    /**
     * Renvoie true si les 2 objets appartiennent a la meme classe et ont le
     * meme identifiant (champs id).
     * ATTENTION : si aucun id n'a encore ete affecte aux objets, alors les
     * deux id vaudront 0 et le test renverra true.
     */
