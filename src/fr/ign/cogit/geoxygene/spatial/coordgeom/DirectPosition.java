...
public class DirectPosition {
    ...
    /**
     * Constructeur par defaut (3D): cree un tableau de coordonees à 3
     * dimensions,
     * vide.
     */
     ...
     * Si le tableau passe en parametre est 2D, la 3ieme coordonnee du
     * DirectPosition vaudra NaN.
    ...
    /**
     * Affecte une valeur à la i-eme coordonnees (i=0 pour X, i=1 pour Y, i=2
     * pour Z.).
     */
    ...
    // ////////////////////////////////////////////////////////////////////////////////////////
    /**
     * Deplace le point suivant toutes les dimensions. Le point passe en
     * parametre doit avoir la meme dimension que this.
     */
     ...
     * Si les 2 points ont une troisieme dimension affectee, on teste cette
     * dimension.
     * 
     * @param pt
     *            un point
    ...
    /**
     * Indique si self et le point passe en parametre sont egaux, à une
     * tolerance pres.
     * Si les 2 points ont une troisieme dimension affectee, on teste cette
     * dimension.
     ...
     *            un point
     * @param tolerance
     *            tolerance entre this et le point passe en parametre
     ...
     * Indique si self et le point passe en parametre sont egaux, à une
     * tolerance pres.
     * La comparaison est effectuee en 2D, i.e. la troisieme dimension est
     * ignoree.
     * Tolerance est un double qui doit etre > 0.
     * 
     * @param pt
    ...
    public double distance(DirectPosition d) {
        ...
        if (!Double.isNaN(getZ()) && !Double.isNaN(d.getZ())) {

            double dz = getZ() - d.getZ();
    ...
    @Override
    public Object clone() {
        return new DirectPosition(getCoordinate().clone());
    }
