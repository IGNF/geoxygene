...
/**
 * Polyligne.
 * L'attribut "interpolation" est egal à "linear".
 * 
...
public class GM_LineString extends GM_CurveSegment {
	...
	//////////////////////////////////////////////////////////////////////////
	/** Points pour le dessin de la polyligne : sequence de DirectPosition.
	...
	public DirectPositionList getControlPoint() {return this.controlPoint;}
	...
	/** 
	 * TODO Renvoie null.
	 * Decompose une polyligne en une sequence de segments.
	 */
	...
	@Override
	public DirectPositionList coord() {return this.controlPoint;}
	...
	public GM_CurveSegment reverse() {
		...
		for (int i=0; i<n; i++) result.getControlPoint().add(this.controlPoint.get(n-1-i));
		return result;
	}
	...
	@Override
	public Object clone() {return new GM_LineString((DirectPositionList) this.controlPoint.clone());}
