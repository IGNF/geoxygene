...
class GM_Tin extends GM_TriangulatedSurface {
	...
	/**
	 * Lignes ou la continuite locale ou la regularite de la surface est remise en cause : un triangle intersectant une telle ligne doit etre enleve du TIN en laissant un trou à la place.
	 */
	...
	/**
	 * Longueur maximum de l'arete d'un triangle du TIN. Tout triangle adjacent à une arete dont la longueur est superieure à maxLength doit etre supprime de la triangulation. (NORME : cet attribut est de type Distance.)
	 */
