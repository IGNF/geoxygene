 ...
 *
 * <P> Definition de la norme : les classes GM_Curve et GM_CurveSegment representent toutes deux des geometries à une dimension, et partagent donc plusieurs signatures d'operation.
...
interface GM_GenericCurve {
	...
	/** NON IMPLEMENTE.
	 * Vecteur tangent a la courbe, à l'abscisse curviligne  passee en parametre. Le vecteur resultat est norme.
	 */
	// NORME : le parametre en entree est de type Distance.
	...
	/**
	 * Longueur de la courbe pour une GM_Curve. Pour un GM_CurveSegment, egale à startParam plus la longueur du segment.
	 */
	// NORME : le resultat est de type Distance.
	double endParam();
	 ...
	 * Si ces 2 parametres sont à 0, alors aucune contrainte n'est imposee.
