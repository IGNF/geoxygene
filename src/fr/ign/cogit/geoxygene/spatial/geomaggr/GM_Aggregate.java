...
/**
 * Agregation quelconque d'objets geometriques. Il n'y a aucune structure interne.
...
public class GM_Aggregate<GeomType extends GM_Object> extends GM_Object implements Collection<GeomType>{
	...
	public void setList (List<GeomType> L) {this.element = L; }
	 ...
	 * Collection de GM_Object representant la frontiere de self.
