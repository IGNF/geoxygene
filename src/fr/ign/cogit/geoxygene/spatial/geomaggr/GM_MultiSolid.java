...
public class GM_MultiSolid<SolidType extends ISolid> extends
  ...
  public double area() {
    GM_MultiSolid.logger
        .error("Non implémentée, utiliser : return CalculSansJava3D.CalculAire(this); (renvoie 0.0)");
    return 0.0;
  }
  ...
  /*
   * public GM_MultiSolid(ICompositeSolid compSolid) { element = new
   * ArrayList<SolidType>(); element.addAll(compSolid.getGenerator()); }
   */
