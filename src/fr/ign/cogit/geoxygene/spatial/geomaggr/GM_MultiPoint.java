...
public class GM_MultiPoint extends GM_MultiPrimitive<IPoint> implements
  ...
  public GM_MultiPoint(IDirectPositionList list) {
    this.element = new ArrayList<IPoint>(list.size());
    for (IDirectPosition position : list) {
