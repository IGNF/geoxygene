 ...
 * <P> L'opération "Boundary" redéfinie sur TP_Object renvoie 
 * un set de TP_DirectedFace avec les orientations adéquates.
 * Cette opération est aussi une association.
...
class TP_Solid extends TP_DirectedSolid {
	...
	public void setId(int Id) {
		...
		if (Id<0) System.out.println("TP_Solid::setId(id) : L'identifiant doit être positif"); //$NON-NLS-1$
	}
	...
	public TP_DirectedSolid asTP_DirectedTopo(int sign)  {
		if (sign == +1) return this.proxy[0];
			...
			System.out.println("TP_Solid::asTP_DirectedTopo(sign) : Passer +1 ou -1 en paramètre."); //$NON-NLS-1$
			return null;
		}
	}
