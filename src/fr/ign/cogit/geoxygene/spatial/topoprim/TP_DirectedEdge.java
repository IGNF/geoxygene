...
public class TP_DirectedEdge extends TP_DirectedTopo {
    ...
    public TP_EdgeBoundary boundary()  {
        ...
        // si le brin est négatif on retourne tout
            ...
            TP_EdgeBoundary boundary = (TP_EdgeBoundary)this.topo().boundary();
            TP_DirectedNode startNode = (TP_DirectedNode)boundary.getStartnode().negate();
            TP_DirectedNode endNode = (TP_DirectedNode)boundary.getEndnode().negate();
    ...
    public List coBoundary()  {
        ...
        // si le brin est négatif on retourne tout        
            ...
            for (int i=0; i<coBoundary.size(); i++) {
                ...
                TP_DirectedFace directedFace2 = (TP_DirectedFace)directedFace1.negate();
    ...
    public List nextEdgesList()  {
        ...
        for (int i=0; i<coBdy.size(); i++) {
            ...
            TP_DirectedEdge dirEdgeNeg = (TP_DirectedEdge)dirEdge.negate();
    ...
    public TP_DirectedEdge nextEdge()  {
        ...
        if (coBdy.size() == 0)result = (TP_DirectedEdge)this.negate();
        ...
        result = (TP_DirectedEdge)result.negate();
        return result;
    }
