 ...
 * renvoie ici une liste de TP_DirectedFace, indiquant quelles faces ont self pour frontiere.
 * Cette liste n'est pas ordonnee.
 * <P> L'operation "Boundary" redefinie sur TP_Object 
 * renvoie le point initial du brin (TP_DirectedNode negatif) et le point final (TP_DirectedNode positif) ;
...
public class TP_Edge extends TP_DirectedEdge {
	...
	public void setId(int Id) {
		...
		if (Id<0) System.out.println("TP_Edge::setId(id) : L'identifiant doit être positif"); //$NON-NLS-1$
	}
	...
	public TP_DirectedEdge asTP_DirectedTopo(int sign)  {
		if (sign == +1) return this.proxy[0];
			...
			System.out.println("TP_Edge::asTP_DirectedTopo(sign) : Passer +1 ou -1 en paramètre."); //$NON-NLS-1$
			return null;
		}
	}
	...
	public TP_Solid getContainer() {return this.container;}
	public void setContainer(TP_Solid Container) {this.container= Container;}
	...
	public TP_Node getStartnode() {return this.startnode;}
	...
	public int getStartnodeID() {return this.startnodeID; }
	public void setStartnodeID(int StartnodeID) {this.startnodeID = StartnodeID;}

	/** Noeud final. */
	public TP_Node endnode;
	public TP_Node getEndnode() {return this.endnode;}
	...
	public int getEndnodeID() {return this.endnodeID; }
	...
	public List<?> coBoundary()  {
		...
		if (this.leftface != null) result.add(this.leftface.asTP_DirectedTopo(+1));
		if (this.rightface != null) result.add(this.rightface.asTP_DirectedTopo(-1));
		return result;
	}

	/** Face gauche. */
	public TP_Face leftface;
	public TP_Face getLeftface() {return this.leftface;}
	public void setLeftface(TP_Face Leftface) {
		if (Leftface==null) {
			this.leftface = null;
			this.leftfaceID = 0;
		} else if (Leftface.getId() == -1) this.leftface = null;
		else {
	...
	public int getLeftfaceID() {return this.leftfaceID;}
	public void setLeftfaceID(int LeftfaceID) {this.leftfaceID = LeftfaceID;}

	/** Face droite. */
	public TP_Face rightface;
	public TP_Face getRightface() {return this.rightface;}
	public void setRightface(TP_Face Rightface) {
		if (Rightface == null) {
			this.rightface = null;
			this.rightfaceID = 0;
		} else if (Rightface.getId() == -1) this.rightface = null;
		else {
	...
	public int getRightfaceID() {return this.rightfaceID;}
	public void setRightfaceID(int RightfaceID) {this.rightfaceID = RightfaceID;}
