...
/**
 * Classe mère abstraite pour les primitives topologiques. Par définition, une
 * primitive est orientée positivement. Une primitive possède 2 TP_DirectedTopo
 * orientés positivement et négativement. Le TP_DirectedTopo orienté
 * positivement est sa propre primitive.
 * 
...
abstract public class TP_Primitive extends TP_Object {
  ...
  public void setGeom(GM_Primitive value) {
    this.geom = value;
  }
  ...
  // / cette methodes est definie dans les sous-classes avec un bon typage en
  // sortie ///
  // ///////////////////////////////////////////////////////////////////////////////////
  // Conversion en TP_DirectedTopo.
  // public TP_DirectedTopo asTP_DirectedTopo(DataSource data, int orientation)
  // throws Exception {
  // return null;
  // }
