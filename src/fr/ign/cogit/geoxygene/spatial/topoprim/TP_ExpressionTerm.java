...
/**
 * non utilisé. Cette classe est cependant présente dans la norme. Terme de
 * l'expression polynomiale TP_Expression : un coefficient (égal à +1, -1 ou 0)
 * et une variable (TP_DirectedTopo). Il me parait plus simple d'utiliser
 * directement le TP_DirectedTopo comme variable, et l'orientation comme
 * coefficient.
 * 
