...
public class GM_Ring extends GM_CompositeCurve {
   ...
   // TO DO : un nouveau type d'exception
    ...
    public boolean validate(double tolerance) {
        ...
        GM_CurveBoundary bdy = (GM_CurveBoundary)this.boundary();
        if (bdy.getStartPoint().getPosition().equals(bdy.getEndPoint().getPosition(),tolerance))
            return true;
        else return false;
    }
}
