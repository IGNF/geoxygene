 ...
 * Une surface orientée positivement à sa frontière dans le sens direct 
 * (la surface est à gauche de la frontière).
 * Une surface orientée négativement à sa frontière dans le sens des aiguilles d'une montre 
 * (la surface est à droite de la frontière).
...
public class GM_OrientableSurface extends GM_OrientablePrimitive {
	...
	/** Redéfinition de l'opérateur "boundary" sur GM_Object. 
	 * Renvoie une GM_SurfaceBoundary, c'est-à-dire un GM_Ring pour
	...
	public GM_SurfaceBoundary boundary() {
		...
		System.out.println("GM_OrientableSurface::boundary() : cette méthode ne fonctionne que pour les surfaces composées d'un et d'un seul patch."); //$NON-NLS-1$
		return null;
	}
