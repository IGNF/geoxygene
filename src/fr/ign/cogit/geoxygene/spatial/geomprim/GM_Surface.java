...
public class GM_Surface extends GM_OrientableSurface 
    ...
    public void setPatch (int i, GM_SurfacePatch value) {
        if ((GM_SurfacePatch.class).isAssignableFrom(this.getClass()))
            if (i != 0)
                System.out.println("Affection d'un patch avec i<>0 alors qu'un GM_SurfacePatch ne contient qu'un segment qui est lui-meme. La méthode ne fait rien.");
    ...
    public void addPatch (GM_SurfacePatch value) {
        if ((GM_SurfacePatch.class).isAssignableFrom(this.getClass()))
            if (sizePatch() > 0)
                System.out.println("Ajout d'un patch alors qu'un GM_SurfacePatch ne contient qu'un segment qui est lui-meme. La méthode ne fait rien.");
    ...
    public void addPatch (int i, GM_SurfacePatch value) {
        if ((GM_SurfacePatch.class).isAssignableFrom(this.getClass()))
            if (i != 0)
                System.out.println("Ajout d'un patch avec i<>0 alors qu'un GM_SurfacePatch ne contient qu'un segment qui est lui-meme. La méthode ne fait rien.");
            else this.patch.add(value);                     
   ...
   /* public double area()  {
    ...
    public GM_LineString exteriorLineString() {
        if (this.sizePatch() == 1) {
            ...
            System.out.println("GM_Surface::exteriorLineString() : cette méthode ne fonctionne que si la surface est composée d'un seul patch.");
            return null;
        }
    }
   ...
   /** Renvoie la frontière extérieure sous forme d'une GM_Curve. 
    ...
    public GM_Curve exteriorCurve() {
        if (this.sizePatch() == 1) {
            ...
            System.out.println("GM_Surface::exteriorCurve() : cette méthode ne fonctionne que si la surface est composée d'un seul patch.");
            return null;
        }
    }
    ...
    public GM_LineString interiorLineString(int i) {
        if (this.sizePatch() == 1) {
           ...
           if (inte != null) {
            ...
            System.out.println("GM_Surface::interiorLineString() : cette méthode ne fonctionne que si la surface est composée d'un seul patch");
            return null;
        }
    }
   ...
   /** Renvoie la frontière intérieure de rang i sous forme d'une GM_Curve. 
    ...
    public GM_Curve interiorCurve(int i) {
        if (this.sizePatch() == 1) {
            ...
            System.out.println("GM_Surface::interiorCurve() : cette méthode ne fonctionne que si la surface est composée d'un seul patch");
            return null;
        }
    }
      ...
      public DirectPositionList coord ()  {
        if (this.sizePatch() == 1) {  
           ...
           return dpl; 
            ...
            System.out.println("GM_Surface::coord() : cette méthode ne fonctionne que si la surface est composée d'un seul patch");
            return null;
        }
    }  
