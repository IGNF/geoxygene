...
/** NON UTILISE.
  * Représente la frontière d'un GM_Solid.
  * Un GM_SolidBoundary est constitué de 0 ou 1 shell extérieur et d'une liste de shells intérieurs 
  * pour éventuellement représenter les solides à trous. 
  * (le cas de 0 shell extérieur est prévu par le modèle mais je n'ai pas compris pourquoi).  
  * <P> A revoir : redéfinir les constructeurs, et tester.
  * 
...
class GM_SolidBoundary extends GM_PrimitiveBoundary {
    ...
    public GM_Shell getInterior (int i) {return (GM_Shell)this.interior.get(i);}
