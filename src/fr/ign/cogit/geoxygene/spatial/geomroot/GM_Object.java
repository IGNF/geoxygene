...
/**
  ...
  * 
  * <BR> Les methodes geometriques font par defaut appel a la bibliotheque JTS (jts.jar, version 1.4),
  ...
  * 
  * <BR> Historiquememt, les methodes faisaient appel aux fonctions geometriques d'Oracle 
...
//    public void setFeature(FT_Feature Feature) { this.feature = Feature;}
    ...
    public GM_Envelope envelope() {   
        ...
        DirectPosition point = list.get(0);
