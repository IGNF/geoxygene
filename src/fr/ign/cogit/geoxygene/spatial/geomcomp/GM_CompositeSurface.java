 ...
 * (problème de double héritage en java). 
 * Les méthodes et attributs ont été reportés.
 *
 *  <P> ATTENTION : normalement, il faudrait remplir le set "element"
 *  (contrainte : toutes les primitives du generateur sont dans le complexe).
 *  Ceci n'est pas implémenté pour le moment.
...
public class GM_CompositeSurface extends GM_Composite {
    ...
    public GM_OrientableSurface getGenerator(int i) {
        return this.generator.get(i);
    }

    /**
     * Affecte une GM_OrientableSurface au rang i.
     * Attention : aucun contrôle de continuité n'est effectué.
     */
    public void setGenerator(int i, GM_OrientableSurface value) {
        this.generator.set(i, value);
    }

    /**
     * Ajoute une GM_OrientableSurface en fin de liste.
     * Attention : aucun contrôle de continuité n'est effectué.
     */
    public void addGenerator(GM_OrientableSurface value) {
        this.generator.add(value);
    }

    /**
     * A FAIRE.
     * Ajoute une GM_OrientableSurface en fin de liste avec un contrôle de
     ...
     * @throws Exception
     */
    public void addGenerator(GM_OrientableSurface value, double tolerance)
    throws Exception {
    }
     ...
     * Ajoute une GM_OrientableSurface en fin de liste avec un contrôle de
     * continuité avec la tolérance passée en paramètre.
     * Eventuellement change le sens d'orientation de la surface pour assurer
     * la continuite.
     * Envoie une exception en cas de problème.
     * @param value
     * @param tolerance
     * @throws Exception
     */
    public void addGeneratorTry(GM_OrientableSurface value, double tolerance)
    throws Exception {
    }

    /**
     * Ajoute une GM_OrientableSurface au rang i.
     * Attention : aucun contrôle de continuité n'est effectué.
     * */
    public void addGenerator(int i, GM_OrientableSurface value) {
        this.generator.add(i, value);
    }

    /**
     * Efface la (ou les) GM_OrientableSurface passé en paramètre.
     * Attention : aucun contrôle de continuité n'est effectué.
     */
    ...
    /**
     * Efface la GM_OrientableSurface de rang i.
     * Attention : aucun contrôle de continuité n'est effectué.
     */
    ...
    /**
     * Primitive.
     * Elle doit etre recalculée à chaque modification de self :
    ...
    /**
     * Redéfinition de l'opérateur "boundary" sur GM_OrientableSurface.
     * Renvoie une GM_SurfaceBoundary.
     */
     ...
     * Vérifie la continuité des composants. Renvoie TRUE s'ils sont contigus,
     * FALSE sinon.
     * Cette méthode n'est pas dans la norme.
     * @param tolerance
     * @return <code>true</code> if composite surface is validated with the
     * given tolerance; <code>false</false> otherwise.
     */
