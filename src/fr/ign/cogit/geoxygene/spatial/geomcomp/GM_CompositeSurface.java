...
public class GM_CompositeSurface extends GM_Composite {
  ...
  public List<GM_OrientableSurface> getGenerator() {
  ...
  /**
   * Ajoute une GM_OrientableSurface au rang i. Attention : aucun contrôle de
   * continuité n'est effectué.
   * */
  ...
  /**
   * Efface la (ou les) GM_OrientableSurface passé en paramètre. Attention :
   * aucun contrôle de continuité n'est effectué.
   */
  ...
  /**
   * Efface la GM_OrientableSurface de rang i. Attention : aucun contrôle de
   * continuité n'est effectué.
   */
  ...
  // //////////////////////////////////////////////////////////////////////
  /**
   * A FAIRE - renvoie toujours true pour le moment. Vérifie la continuité des
   * composants. Renvoie TRUE s'ils sont contigus, FALSE sinon. Cette méthode
   * n'est pas dans la norme.
   * @param tolerance
   * @return <code>true</code> if composite surface is validated with the given
   *         tolerance; <code>false</false> otherwise.
   */
