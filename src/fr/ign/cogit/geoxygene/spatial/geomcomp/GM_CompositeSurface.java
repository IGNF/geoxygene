...
public class GM_CompositeSurface extends GM_Composite {
    ...
    public GM_OrientableSurface getGenerator (int i) {return (GM_OrientableSurface)this.generator.get(i);}
    ...
    public GM_CompositeSurface() {
        ...
        proxy[0] = (GM_Surface)primitive;
        GM_OrientableSurface proxy1 = new GM_OrientableSurface();
        proxy1.orientation = -1;
        proxy1.proxy[0] = (GM_Surface)primitive;
        proxy1.proxy[1] = proxy1;
        proxy1.primitive = new GM_Surface((GM_Surface)primitive);
        proxy[1] = proxy1;
    }
