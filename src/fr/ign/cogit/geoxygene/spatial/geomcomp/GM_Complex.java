...
/**
 * NON TESTE.
 * Un complexe est un set de primitives géométriques dont les intérieurs sont
 * disjoints.
 * De plus, si une primitive est dans un complexe, alors il existe un set de
 * primitives dans le complexe dont l'union en forme la frontière.
 * <P> ATTENTION : pour le moment, la contrainte qui impose que si un élément
 * est dans un complexe, sa frontière est dans un complexe, n'est pas
 * implémentée.
...
public class GM_Complex extends GM_Object {
    ...
    /**
     * Efface la primitive passée en paramètre (efface aussi le complexe de
     * la primitive).
     */
