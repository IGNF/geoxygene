...
public class GM_Complex extends GM_Object {
    ...
    protected Set element = new HashSet();
    
    /** Renvoie le set des primitives */
    public Set getElement() {return element;}
    ...
    protected Set subComplex = new HashSet();
    
    /** Renvoie la liste des sous-complexes */
    public Set getSubComplex() {return subComplex;}
    ...
    protected Set superComplex = new HashSet();
    
    /** Renvoie la liste des super-complexes */
    public Set getSuperComplex() {return superComplex;}
