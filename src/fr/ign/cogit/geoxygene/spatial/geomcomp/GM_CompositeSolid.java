...
/**
 * NON UTILISE.
 * Complexe ayant toutes les propriétes géométriques d'un solide.
 * C'est un set de solides (GM_Solid) partageant des surfaces communes.
 * Hérite de GM_Solid, mais le lien n'apparaît pas explicitement (problème de
...
public class GM_CompositeSolid extends GM_Composite {
    ...
    //public GM_Solid getGenerator (int i) {
    //return (GM_Solid)this.generator.get(i);}

    /** Affecte un GM_Solid au rang i. Attention : aucun contrôle de cohérence
     * n'est effectué. */
    //protected void setGenerator (int i, GM_Solid value) {
    //this.generator.set(i, value);}

    /** Ajoute un GM_Solid en fin de liste. Attention : aucun contrôle de
     * cohérence n'est effectué. */
    //protected void addGenerator (GM_Solid value) {this.generator.add(value);}

    /** Ajoute un GM_Solid au rang i. Attention : aucun contrôle de cohérence
     * n'est effectué. */
    //protected void addGenerator (int i, GM_Solid value) {
    //this.generator.add(i, value);}

    /** Efface le (ou les) GM_Solid passé en paramètre. Attention : aucun
     * contrôle de cohérence n'est effectué. */
    ...
    /**
     * Efface le GM_Solid de rang i.
     * Attention : aucun contrôle de cohérence n'est effectué.
     */
