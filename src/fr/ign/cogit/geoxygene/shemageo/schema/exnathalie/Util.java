...
public class Util {
   ...
   */
  public static SchemaConceptuel loadSchema(String nomSchema) {
    SchemaConceptuel schema = null;
    ...
    for (SchemaConceptuel schemaConceptuel : list) {
   ...
   */
  public static void afficheClasses(SchemaConceptuel s) {
    List<GF_FeatureType> lesFT = s.getFeatureTypes();
