...
public class SpatialQuery {
    ...
    public static GM_Object executeGeometry(Geodatabase data, GM_Object isoGeom, String query) {
    ...
    public static GM_Object executeGeometry(Geodatabase data, GM_Object isoGeom1, GM_Object isoGeom2, String query)  {
    ...
    public static String executeString(Geodatabase data, GM_Object isoGeom1, GM_Object isoGeom2, String query)  {
    ...
    public static double executeDouble(Geodatabase data, GM_Object isoGeom1, GM_Object isoGeom2, String query)  {
    ...
    public static double executeDouble(Geodatabase data, GM_Object isoGeom1, String query)  {
    ...
    public static List executeFeatureList(Geodatabase data, GM_Object geom, Class theClass, String theQuery) {
    ...
    public static double distance (Geodatabase data, double tolerance, GM_Object geom1, GM_Object geom2) {
        ...
        double result = SpatialQuery.executeDouble(data,geom1,geom2,query);
        return result;
    }
    ...
    public static DirectPosition centroid (Geodatabase data, double tolerance, GM_Object geom1) {
        ...
        GM_Point thePoint = (GM_Point)SpatialQuery.executeGeometry(data,geom1,query);
    ...
    public static GM_Polygon convexHull (Geodatabase data, double tolerance, GM_Object geom1) {
        ...
        return (GM_Polygon)SpatialQuery.executeGeometry(data,geom1,query);
    }        
    ...
    public static GM_Object buffer (Geodatabase data, double tolerance, double radius, GM_Object geom1) {        
        ...
        return SpatialQuery.executeGeometry(data,geom1,query);
    }
    ...
    public static boolean intersects (Geodatabase data, double tolerance, GM_Object geom1, GM_Object geom2) {  
        ...
        String result = SpatialQuery.executeString(data,geom1,geom2,query);
        if (result.compareToIgnoreCase("FALSE") == 0) {
            ...
            result = SpatialQuery.executeString(data,geom1,geom2,query);
            if (result.compareToIgnoreCase("FALSE") == 0)
                return true;
        }
        return false;
    ...
    public static GM_Object union (Geodatabase data, double tolerance, GM_Object geom1, GM_Object geom2) {            
        ...
        return SpatialQuery.executeGeometry(data,geom1,geom2,query);
    }
    ...
    public static boolean contains (Geodatabase data, double tolerance, GM_Object geom1, DirectPosition P) {
        ...
        return SpatialQuery.contains(data,tolerance,geom1,g);
    }
    ...
    public static List loadAllFeatures(Geodatabase data, Class theClass, GM_Object geom) {
        ...
        return SpatialQuery.executeFeatureList(data,geom,theClass,query);
    }
