 ...
 * Gere la manipulation des donnees via un mappeur objet-relationnel
 * (Castor, OJB).
 *
...
public interface Geodatabase  {
    ...
    /** Charge l'objet d'identifiant id.
        A utilisser avec precaution, car ne charge pas forcement toutes les
        relations.
    ...
    /**
     * Charge tous les objets persistants de la classe featureClass dans la
     * classe featureListClass.
     * A appeler a l'interieur d'une transaction ouverte.
     */
     ...
     * A appeler a l'interieur d'une transaction ouverte.
     * La classe featureClass doit etre une sous-classe de FT_Feature, sinon
     ...
     * featureListClass.
     * A appeler a l'interieur d'une transaction ouverte.
     * La classe featureClass doit etre une sous-classe de FT_Feature,
    ...
    /**
     * Charge tous les FT_Feature de la classe featureClass a une distance dist
    ...
    /**
     * Calcule DANS LE SGBD l'emprise la table mappee avec la classe (utile
     * pour Oracle ...).
     ...
     * Utile uniquement pour debugger : on ne doit pas utiliser de SQL direct
     * avec GeOxygene !
     ...
     * ATTENTION : La classe passee en parametre doit avoir un champ "id" de
     * type int (marche pour les FT_Feature).
     * A appeler a l'interieur d'une transaction ouverte.
     */
