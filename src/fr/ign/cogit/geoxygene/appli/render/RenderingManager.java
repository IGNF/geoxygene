...
public class RenderingManager {
  ...
  public void repaint() {
    RenderingManager.LOGGER.debug(this.getRenderers().size() + " renderers");
    ...
    for (Renderer r : this.getRenderers()) {
      if (r.isRendering() || !r.isRendered()) {
        RenderingManager.LOGGER.debug("Renderer " + r.isRendering() + " - "
            + r.isRendered());
        return;
      }
    }
    if (this.selectionRenderer != null
        && (this.selectionRenderer.isRendering() || !this.selectionRenderer
            .isRendered())) {
      RenderingManager.LOGGER.debug("Renderer "
          + this.selectionRenderer.isRendering() + " - "
          + this.selectionRenderer.isRendered());
      return;
    }
    RenderingManager.LOGGER.debug("Repaint");
