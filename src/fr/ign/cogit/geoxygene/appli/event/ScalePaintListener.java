...
//    int rightShift = 80;
    ...
    graphics.fillRect(shift, layerViewPanel.getHeight() - 4 * shift - barHeight,
...
//        - 3 * shift, rightShift, 3 * shift);
    ...
    graphics.drawRect(shift, layerViewPanel.getHeight() - 4 * shift - barHeight,
...
//        - 3 * shift, rightShift - 1, 3 * shift - 1);
    ...
    graphics.fillRect(2 * shift, layerViewPanel.getHeight() - 2 * shift - barHeight,
        barLength, barHeight);
