...
public class CoordPaintListener implements MouseMotionListener{
	...
	public void mouseMoved(MouseEvent e) {
		displayCoord(e.getPoint(), (LayerViewPanel)e.getSource());
	}
	...
	public static void displayCoord(Point pointMouse, LayerViewPanel layerViewPanel) {
		try {
			DirectPosition point =
				layerViewPanel.getViewport().toModelDirectPosition(pointMouse);
	        ...
	        graphics.fillRect(
	        		layerViewPanel.getWidth() - numericScaleLength - coordRectLength,
	        		layerViewPanel.getHeight() - 3 * shift,
	        		coordRectLength,
	        		3 * shift);
	        ...
	        graphics.drawRect(
	        		...
	        		3 * shift - 1);
	        graphics.drawString(
	        		"X : " + Math.round(point.getX()) + "     -     Y : " + Math.round(point.getY()),
	        		layerViewPanel.getWidth() - numericScaleLength - coordRectLength + shift,
