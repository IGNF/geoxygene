...
public class SLDDemoApplication extends GeOxygeneApplication {
    ...
    public static void main(final String[] args) {
        ...
        Layer layer2 = projectFrame.getSld().createLayer("Batiment", //$NON-NLS-1$
                    GM_Polygon.class, Color.blue, Color.gray,
                    1f, 2);
        ...
        pop2.add(new DefaultFeature(new GM_Polygon(new GM_Envelope(110, 200, 110, 200))));
        ...
        Layer layer3 = projectFrame.getSld().createLayer("Route", //$NON-NLS-1$
                    GM_LineString.class, Color.red, Color.red,
                    1f, 4);
        ...
        */
        ...
        pop3.add(new DefaultFeature(new GM_LineString(new DirectPositionList(Arrays.asList(
                    new DirectPosition(110,0),
                    new DirectPosition(110,100),
        ...
        //tree.setHref("http://recherche.ign.fr/labos/cogit/img/LOGO_COGIT.gif"); //$NON-NLS-1$
        //tree.setFormat("gif"); //$NON-NLS-1$
        URL urlCircles = SLDDemoApplication.class.getResource("/images/circles.png"); //$NON-NLS-1$
        ...
        */
        ...
        pop4.add(new DefaultFeature(new GM_LineString(new DirectPositionList(Arrays.asList(
                    new DirectPosition(0,110),
                    new DirectPosition(100,110),
