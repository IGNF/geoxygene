...
public class StyleEditionFrame
	...
	public void init_Line(){
		...
		strokePanel.setBorder(strokeTitleBorder);
		strokePanel.setPreferredSize(new Dimension(500, 500));
		...
		addColorMapButton = new JButton("Add ColorMap");
		addColorMapButton.addActionListener(this);
		strokePanel.add(addColorMapButton);
		...
		if(layer.getStyles().size()==2){
			...
			strokePanel2.setPreferredSize(new Dimension(500, 500));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == addColorMapButton) {
		    if (layer.getSymbolizer().isLineSymbolizer()) {
		        LineSymbolizer ls = (LineSymbolizer) layer.getSymbolizer();
		        List<GF_AttributeType> attributes = layer.getFeatureCollection().getFeatureType().getFeatureAttributes();
