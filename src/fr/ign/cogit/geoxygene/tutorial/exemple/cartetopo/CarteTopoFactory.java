...
public class CarteTopoFactory {
    ...
    public static CarteTopo creeCarteTopoDefaut(
        ...
        Iterator<FT_Feature> it =
            (Iterator<FT_Feature>) collection.getElements().iterator();
        FT_Feature feature;
        Arc arc;
        ...
        logger.info(
        "création des faces de la carte topologique"); //$NON-NLS-1$
    ...
    public static CarteTopo creeCarteTopoEtendue(
        ...
        //Initialisation d'une nouvelle CarteTopo
        CarteTopoEtendue carteTopo =
            new CarteTopoEtendue("Graphe"); //$NON-NLS-1$
