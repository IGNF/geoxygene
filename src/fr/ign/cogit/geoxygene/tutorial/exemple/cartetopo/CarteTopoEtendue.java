...
/**
 * Carte topologique étendue qui utilise des noeuds valués (degré du noeud)
 * 
...
public class CarteTopoEtendue extends CarteTopo {
  ...
  public CarteTopoEtendue(String nomLogique) {
    ...
    this.addPopulation(new Population<NoeudValue>(false, "Noeud",
        NoeudValue.class, true));
    this.addPopulation(new Population<Arc>(false, "Arc", Arc.class, true));
    this.addPopulation(new Population<Face>(false, "Face", Face.class, true));
    this.addPopulation(new Population<Groupe>(false, "Groupe", Groupe.class,
        true));
  }
