...
public class TestCarteTopoFaceCirculaire {
  ...
  public static void main(String[] args) {
    ...
    FT_FeatureCollection<Face> facesCirculaires = CarteTopoAlgorithmie
    ...
    viewer.addFeatureCollection(tronconsBDT, "Tronçons routiers"); //$NON-NLS-1$
    viewer.addFeatureCollection(facesCirculaires, "Faces circulaires"); //$NON-NLS-1$
  }
}
