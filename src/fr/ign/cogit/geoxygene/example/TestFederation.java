...
public class TestFederation {
	...
	public static void main(String args[]) {
		...
		try {
			featureClass1 = (Class<? extends FT_Feature>) Class.forName("geoxygene.geodata.Troncon_voie_ferree");
			featureClass2 = (Class<? extends FT_Feature>) Class.forName("geoxygene.geodata.Troncon_voie_ferree_50");
		} catch (Exception e) {
			e.printStackTrace();
			return;
		}
		...
		FT_FeatureCollection< ? extends FT_Feature> coll1 = db1.loadAllFeatures(featureClass1);
		t2 = System.currentTimeMillis();
		System.out.println( (t2-t1) / 1000. );

		System.out.print("chargement ... "+featureClass2.getName()+"  ");
		t1 = System.currentTimeMillis();
		FT_FeatureCollection<? extends  FT_Feature> coll2 = db2.loadAllFeatures(featureClass2);
		t2 = System.currentTimeMillis();
		System.out.println( (t2-t1) / 1000. );
