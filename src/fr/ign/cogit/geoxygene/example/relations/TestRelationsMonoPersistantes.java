 ...
 * C'est le meme que "TestRelationsMonoNonPersistantes",
...
public class TestRelationsMonoPersistantes {
	...
	public static void charge() {
		db.begin();
		List<AAA> allAAA = db.loadAll(AAA.class);
		...
		while (itA.hasNext()) {
			...
			if (a.getObjetBBB_mono11() != null)
				System.out.print("id = "+a.getObjetBBB_mono11().getId()+" - nom = "+a.getObjetBBB_mono11().getNom());
			System.out.println();
			System.out.println("        lien 1-n : ");
			affiche(a.getListe_objetsBBB_mono1N());
			System.out.println("        lien n-m : ");
			affiche(a.getListe_objetsBBB_monoNM());
		}
	}
