...
public class Troncon_cours_eau extends
  ...
  public void setArtif(int Artif) {
    this.artif = Artif;
  }

  protected int fictif;

  public int getFictif() {
    return this.fictif;
  }

  public void setFictif(int Fictif) {
    this.fictif = Fictif;
  }
  ...
  public String getFranchisst() {
    return this.franchisst;
  }

  public void setFranchisst(String Franchisst) {
    this.franchisst = Franchisst;
  }
  ...
  public int getPosit_sol() {
    return this.posit_sol;
  }

  public void setPosit_sol(int Posit_sol) {
    this.posit_sol = Posit_sol;
  }
