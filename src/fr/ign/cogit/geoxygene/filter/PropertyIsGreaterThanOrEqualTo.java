 ...
 *
 */
public class PropertyIsGreaterThanOrEqualTo extends BinaryComparisonOpsType {
	static Logger logger=Logger.getLogger(PropertyIsGreaterThanOrEqualTo.class.getName());
