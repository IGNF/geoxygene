...
public abstract class ComparisonOpsType extends Filter {
	 ...
	 */
	public PropertyName getPropertyName() {return this.propertyName;}

	/**
	 * Affecte la valeur de l'attribut propertyName.
	 * 
	 * @param propertyName
	 *            l'attribut propertyName à affecter
	 */
	 ...
	 */
	public Literal getLiteral() {return this.literal;}

	/**
	 * Affecte la valeur de l'attribut literal.
	 * 
	 * @param literal
	 *            l'attribut literal à affecter
	 */
