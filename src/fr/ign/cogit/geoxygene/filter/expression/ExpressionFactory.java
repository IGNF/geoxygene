...
public class ExpressionFactory {
	...
	public static Expression createExpression(String type) {
		...
		if (type.equalsIgnoreCase("sub")) return new Subtract();
		if (type.equalsIgnoreCase("mul")) return new Multiply();
		if (type.equalsIgnoreCase("div")) return new Divide();
		if (type.equalsIgnoreCase("literal")) return new Literal();
