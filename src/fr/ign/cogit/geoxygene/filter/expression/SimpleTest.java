...
public class SimpleTest {
	...
	public void testArithmeticExpressions() {
		...
		subtract.getParameters().add(new Literal("100"));
		Multiply multiply = new Multiply();
		Subtract subtract2 = new Subtract();
		subtract2.getParameters().add(new Literal("0"));
		subtract2.getParameters().add(new Literal("20"));
		System.out.println("subtract2 = "+subtract2.evaluate(null));
		multiply.getParameters().add(subtract2);
		multiply.getParameters().add(new Literal("5"));
		...
		multiply2.getParameters().add(new Literal("100"));
		multiply2.getParameters().add(new Literal("0"));
