...
/**
 * This Class represents a color Slice, it is a component of a {@link ColorWheel}.
 * 
 * @author Charlotte Hoarau
 *
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ColorSlice", propOrder = {
  "hue",
  "colors",
...
public class ColorSlice {
    ...
    public List<ColorimetricColor> getColors() {
        if (colors == null) {
        	colors = new ArrayList<ColorimetricColor>();
        }
        return this.colors;
    }
	...
	public int getIdSaturationParentWheel() {
		return idSaturationParentWheel;
	}
