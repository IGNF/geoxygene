 ...
 *
 */
public class PolygonSymbolizerConverter implements Converter {

	@Override
	public void marshal(Object source, HierarchicalStreamWriter writer, MarshallingContext context) {
		PolygonSymbolizer symbolizer = (PolygonSymbolizer) source;
	...
	public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
		...
		while(reader.hasMoreChildren()) {
			...
			if (reader.getNodeName().equalsIgnoreCase("geometry")) {
				...
				Stroke stroke = (Stroke) context.convertAnother(symbolizer,Stroke.class);
	...
	@Override
	public boolean canConvert(Class classe) {return classe.equals(PolygonSymbolizer.class);}
