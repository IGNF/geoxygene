...
public class RasterSymbolizer extends AbstractSymbolizer {
  ...
  //
  // double shadeBlack = -(or[0] * dirShadeBlackX + or[1] * dirShadeBlackY +
  // or[2]
  // * dirShadeBlackZ)
  // / Math.sqrt(dirShadeBlackX * dirShadeBlackX + dirShadeBlackY
  // * dirShadeBlackY + dirShadeBlackZ * dirShadeBlackZ);
  // double shadeYellow = -(or[0] * dirShadeYellowX + or[1] * dirShadeYellowY +
  // or[2]
  // * dirShadeYellowZ)
  ...
  // }
  //
  // private void addNeighbour(IDirectPosition directPosition, GM_Triangle
  // triangle) {
