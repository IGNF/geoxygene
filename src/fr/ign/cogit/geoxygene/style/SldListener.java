...
/**
 * Listener on the SLD model used by the views of the sld. Any new signal
 * emitted by the model should be caught by this listener.
 * @see StyledLayerDescriptor
 * @see LayerViewPanel
 * @see LayerLegendPanel
 * @author Bertrand Dumenieu
 * 
 */
public interface SldListener extends ActionListener {
