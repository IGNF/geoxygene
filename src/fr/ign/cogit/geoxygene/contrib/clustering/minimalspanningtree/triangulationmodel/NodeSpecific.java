...
/** 
 * A specific node is the node type of the triangulation model
 * used in the minimal spanning tree clustering algorithm
...
public class NodeSpecific extends NoeudDelaunay {
	...
	/**
	 * Sets the status of this node: true if the node is linked to a cluster, otherwise false.
	 * 
	 * @param clusterLinked true if the node is linked to a cluster, otherwise false.
	 */
	...
	/**
	 * True if all the clustering tests have been computed for this node, otherwise false.
	 */
	private boolean fullyTested;

	/**
	 * Returns true if all the clustering tests have been computed for this node, otherwise false.
	 * 
	 * @return true if all the clustering tests have been computed for this node, otherwise false
	 */
	...
	/**
	 * Sets the status of this node: true if all the clustering tests have been computed for this node,
	 * otherwise false.
	 * 
	 * @param fullyTested true if all the clustering tests have been computed for this node, otherwise false.
	 */
    ...
    /**
     * Define the cluster in relation with this node, and update the inverse relation.
     * 
