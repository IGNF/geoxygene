...
public class CarteTopoFactory {
	...
	/**
	 * Create a topological map from a feature collection, a name and a
	 * threshold. The threshold is used for node creation as well as for
	 * topology and planar map creations.
	 * <p>
	 * Création d'une CarteTopo à partir d'une FT_FeatureCollection, d'un
	 * nom et d'un seuil. Ce dernier sert à créer les noeuds manquants, la
	 * topologie arc-noeud et pour rendre le graphe planaire.
