...
/**
 * Exemple de construction et d'utilisation d'une carte topo simple, héritée du
 * schéma générique de la cartetopo.
 * 
 * La carte topo en question est definie par heritage à partir des classes du
 * package : MonNoeud, MonArc, MaFace, MaCarteTopo (on n'utilise pas de groupes
 * dans cet exemple).
 * 
 ...
 * 
 * NB: il est bien entendu possible d'uiliser une cartetopo par défaut si la
 * surcharge des classes arcs, noeuds et faces n'est pas necessaire dans
 * l'application.
 * 
...
public class ExempleConstruction {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Nombre de faces de la carte : "
        + ct.getListeFaces().size());

    // Affichage des coordonnees du noeud initial et du noeud final du premier
    // arc
    ...
    // Note : on utilise ici ct.getPopNoeuds() pour afficher. Pour la
    // manipulation,
