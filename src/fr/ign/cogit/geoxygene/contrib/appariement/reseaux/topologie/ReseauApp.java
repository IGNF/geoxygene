...
public class ReseauApp extends CarteTopo {
    ...
    public ReseauApp(String nom_logique) {
		...
		Population arcs = new Population(false, "Arc", ArcApp.class,true);
		this.addPopulation(arcs);
		Population noeuds = new Population(false, "Noeud", NoeudApp.class,true);
		this.addPopulation(noeuds);
		Population faces = new Population(false, "Face", FaceApp.class,true);
		this.addPopulation(faces);
		Population groupes = new Population(false, "Groupe", GroupeApp.class,false);
