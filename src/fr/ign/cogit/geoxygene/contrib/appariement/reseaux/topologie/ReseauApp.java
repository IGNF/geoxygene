...
public class ReseauApp extends CarteTopo {
  ...
  public ReseauApp(String nom_logique) {
    ...
    Population<ArcApp> arcs = new Population<ArcApp>(false, I18N
        .getString("CarteTopo.Edge"), ArcApp.class, true); //$NON-NLS-1$
    this.addPopulation(arcs);
    Population<NoeudApp> noeuds = new Population<NoeudApp>(false, I18N
        .getString("CarteTopo.Node"), NoeudApp.class, true); //$NON-NLS-1$
    this.addPopulation(noeuds);
    Population<FaceApp> faces = new Population<FaceApp>(false, I18N
        .getString("CarteTopo.Face"), FaceApp.class, true); //$NON-NLS-1$
    this.addPopulation(faces);
    Population<GroupeApp> groupes = new Population<GroupeApp>(false, I18N
        .getString("CarteTopo.Group"), GroupeApp.class, false); //$NON-NLS-1$
