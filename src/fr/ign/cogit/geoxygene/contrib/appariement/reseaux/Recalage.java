...
public class Recalage {
   ...
   * ceux-ci ont été appariés. Un lien (correspondant) est gardé entre les
   * nouveaux arcs et leurs correspondants dans le réseau de référence
   * (accessible par arc.getCorrespondants()), IMPORTANT 1: ctARecaler doit être
   * le réseau 1 dans l'appariement, et ctSurLaquelleRecaler le réseau 2.
  ...
  public static CarteTopo recalage(ReseauApp ctARecaler,
    ...
    // sont appariés.
    Iterator<?> itArcsSurLesquelsRecaler = ctSurLaquelleRecaler.getPopArcs()
