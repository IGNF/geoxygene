...
public class FeatureType implements GF_FeatureType {
	...
	public void addRole(GF_AssociationRole Role) {
		this.roles.add(Role);
		if (Role.getFeatureType()!= this) Role.setFeatureType(this);
	}
	/**
	 *
	 */
	...
	public int sizeFeatureOperations() {return this.featureOperations.size();}
	public void addFeatureOperation(GF_Operation value) {this.featureOperations.add(value);}
	...
	public void addGeneralization(GF_InheritanceRelation value) {
		...
		if (value.getSubType() != this) value.setSubType(this); // gestion de la
		// bi-direction
	}
	// /////////////////////////Ajout Nathalie////////////////////////////////////
