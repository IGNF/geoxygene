...
public class SchemaConceptuelJeu implements SchemaConceptuel <FeatureType> {
  ...
  /**
   * Construction d'un schéma de jeu à partir d'un schéma de produit (le schéma
  ...
  public SchemaConceptuelJeu(SchemaConceptuelProduit schemaProduit) {
    ...
    /**
     * Ensuite on fait la meme chose avec les associations et leurs roles, en se
    ...
    while (itASS.hasNext()) {
      ...
      System.out
          .println("is aggregation ? " + currentFCFASS.getIsAggregation());
    ...
    while (itIR.hasNext()) {
      ...
      while (itFTJ.hasNext()) {
        ...
        } else if (currentSCFT.getElementSchemaProduitOrigine().equals(
            currentFCFTSub)) {
  ...
  public void removeFeatureType(FeatureType ft) {
    ...
    /*
     * Suppression des relations de generalisation dans lesquelles la classe a
    ...
    while (iTgeneral.hasNext()) {
      ...
      FeatureType classeMere = (FeatureType) generalisation.getSuperType();
  ...
  public void createFeatureAttribute(FeatureType ft, String nomAtt,
    ...
    /*
     * vérification qu'aucun attribut du même nom n'existe pour cette classe et
     * ajout dans la liste
     */
  ...
  public void removeFeatureAttribute(FeatureType ft, AttributeType att) {
    ...
    /*
     * Recuperation et destruction de toutes les valeurs de l'attribut dans le
  ...
  public void createGeneralisation(FeatureType classeCurr,
    ...
    /*
     * Pour être en relation, les deux classes doivent appartenir à la même BDG
     */
    ...
    while (iTgeneral.hasNext()) {
      ...
      /*
       * Si cette relation de generalisation existe déjà, on avertit et on sort
       */
  ...
  public void createFeatureAssociation(String nomAsso, FeatureType ft1,
    ...
    while (iTassoc.hasNext()) {
      ...
      /*
       * S'il existe déjà une association entre ces deux classes et qu'elle
       * porte le même nom, on prévient et on sort
       */
      if ((ftList.contains(ft2)) & (scfa.getTypeName().equals(nomAsso))) {
        JOptionPane.showMessageDialog(null, "Erreur : Une association nommée "
