...
public class FeatureAttributeValue implements FC_FeatureAttributeValue {
  ...
  public FeatureAttributeValue(FC_FeatureAttributeValue ori) {
    this.code = ori.getcode();
    this.definition = ori.getDefinition();
    this.label = ori.getLabel();
  }
  ...
  /**
   * commodité pour retrouver à quel schéma conceptuel participe cette valeur
   * d'attribut (en passant par l'attribut auquel elle se rapporte).
   **/
