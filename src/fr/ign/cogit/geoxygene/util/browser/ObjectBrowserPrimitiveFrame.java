...
/**
 * Cette classe rend possible l'affichage de l'argument de retour (pour
 * l'instant de type primitif ou chaîne de caractère) renvoyé par une méthode
...
public class ObjectBrowserPrimitiveFrame extends JFrame {
   ...
   * @param value valeur transtypée en chaîne de caractères de l'argument de
   *          retour de la méthode déclenchée.
  ...
  public ObjectBrowserPrimitiveFrame(String title, String value)
    ...
    this.i18nLanguageFile = ResourceBundle.getBundle(
        ObjectBrowserPrimitiveFrame.I18N_LANGUAGE_FILE_LOCATION,
        this.currentLocale);
    // i18nLanguageFile =
    ...
    this.setSize(new Dimension((int) frameSize.getWidth(), (int) frameSize
        .getHeight() + 30));

    this.addWindowListener(new WindowAdapter() {
      @Override
      public void windowClosing(WindowEvent e) {
        ObjectBrowserPrimitiveFrame.this.dispose();
      }
    });
