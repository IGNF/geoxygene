...
/**
 * Cette classe met en oeuvre l'interface graphique (vue et contrôleur) du
 * Navigateur d'objet de GeOxygene, conformement à l'architecture à Modèle
 * séparable de Sun Microsystems.
 * Les méthodes mises à disposition par cette classe sont appelées depuis la
 * classe ObjectBrowser (Modèle).
 *
...
public class ObjectBrowserGUI extends JFrame {
    ...
    /**
     * Insets définissant l'espacement entre les différents composants
    ...
    /**
     * L'objet dont l'interface courante du navigateur d'objet de GeOxygene
     * est la représentation.
     */
    private Object browsedObject;

    /**
     * Flag définissant si l'affichage d'un bandeau contenant le nom du type
    ...
    /**
     * Flag définissant si l'affichage des méthodes publiques, locales et
     * héritées de l'objet a été demandé par le Modèle (ObjectBrowser).
     */
    boolean showPublicMethods;
    /**
     * Flag définissant si l'affichage des méthodes protected, locales et
     * héritées de l'objet a été demandé par le Modèle (ObjectBrowser).
     */
     ...
     *
     * @param browsedObject l'objet que l'interface du navigateur que l'on
     * cherche à construire doit représenter.
     * @param showClassName l'affichage d'un bandeau comportant le nom du type
     * de l'objet est-il demandé ?
     * @param showPublicAttributes l'affichage des attributs publics de l'objet
     * est-il demandé ?
     * @param showProtectedAttributes l'affichage des attributs protected de
     * l'objet est-il demandé ?
     * @param showPublicMethods l'affichage des méthodes publiques, locales et
     * héritées de l'objet est-il demandé ?
     * @param showProtectedMethods l'affichage des méthodes protected, locales et
     * héritées de l'objet est-il demandé ?
     */
    public ObjectBrowserGUI(
        ...
        this.i18nLanguageFile =
            ResourceBundle.getBundle(I18N_LANGUAGE_FILE_LOCATION,
                    this.currentLocale);

        setTitle(this.i18nLanguageFile.getString(
        "DefaultFrameTitle")); //$NON-NLS-1$
    ...
    /**
     * Construit une instance du navigateur d'objet de GeOxygene pour l'objet
     * browsedObject avec un titre de fenêtre faisant référence à className.
     *
     * @param browsedObject l'objet que l'interface du navigateur que l'on
     * cherche à construire doit représenter.
     * @param showClassName l'affichage d'un bandeau comportant le nom du type
     ...
     * @param showPublicMethods l'affichage des méthodes publiques, locales et
     * héritées de l'objet est-il demandé ?
     * @param showProtectedMethods l'affichage des méthodes protected, locales
     * et héritées de l'objet est-il demandé ?
     * @param className le nom du type de l'objet représenté par l'interface du
     * navigateur que l'on cherche à construire.
     */
    public ObjectBrowserGUI(
            Object browsedObject,
            boolean showClassName,
        ...
        setTitle(this.i18nLanguageFile
                .getString("DefaultFrameTitle") //$NON-NLS-1$
                + " " + className); //$NON-NLS-1$
        this.browsedObject = browsedObject;
        this.showClassName = showClassName;
        this.showPublicAttributes = showPublicAttributes;
     ...
     *
     * @param className le nom du type de l'objet représenté par l'interface
     * du navigateur d'objet.
     */
    ...
    private void initInterface() {
        ...
        JMenu file = new JMenu(this.i18nLanguageFile
                .getString("MenuFileLabel")); //$NON-NLS-1$
        JMenuItem item;
        file.add(
                item =
                    new JMenuItem(
                            this.i18nLanguageFile.getString(
                            "MenuFileCloseItemLabel"))); //$NON-NLS-1$
        ...
        file.add(
                item =
                    new JMenuItem(
                            this.i18nLanguageFile.getString(
                            "MenuFileExitItemLabel"))); //$NON-NLS-1$
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                dispose();
                System.exit(0);
        ...
        JMenu edit = new JMenu(this.i18nLanguageFile.getString(
        "MenuEditLabel")); //$NON-NLS-1$
        edit.add(
                item =
                    new JMenuItem(
                            this.i18nLanguageFile.getString(
                            "MenuEditRefreshItemLabel"))); //$NON-NLS-1$
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
    ...
    /**
     * Ajoute un bandeau à l'interface contenant l'affichage du type
     * (className) de l'objet représenté par l'instance courante du
     * navigateur d'objet.
     *
     * @param className le type de l'objet représenté par l'instance courante
     * du navigateur d'objet.
     */
    ...
    /**
     * Ajoute à l'interface du navigateur, la représentation d'un attribut
     * de type primitif ou chaîne de caractères.
     *
    ...
    public void addAttribute(String attrib_label, String attrib_value) {
        JLabel label = new JLabel(attrib_label
    ...
    /**
     * Ajoute à l'interface du navigateur, la représentation d'un attribut de
     * type objet.
     *
     * @param attrib_label le nom de l'attribut.
    ...
    public void addObjectAttribute(
        ...
        object_button.setToolTipText(
                "Visualiser l'objet de type " //$NON-NLS-1$
    ...
    /**
     * Ajoute à l'interface du navigateur, un composant graphique représentant
     * le contenu d'un tableau ou d'une collection de type primitif ou chaîne
     * de caractères.
     * <p>
     * ATTENTION: méthode vouée à disparaêtre, car remplacée par
     * addObjectAttributeList() !
     * </p>
     * @param attrib_values un vecteur contenant l'ensemble des valeurs de
     * l'objet de type tableau ou collection.
     */
    public void addAttributeList(Vector<Object> attrib_values) {
        addObjectAttributeList(this.i18nLanguageFile.getString(
        "DefaultCollectionClassesContentLabel"),attrib_values); //$NON-NLS-1$
    }

    /**
     * Ajoute à l'interface du navigateur, un composant graphique représentant
     * le contenu d'un attribut de type tableau ou collection de type primitif
     ...
     * </p>
     * @param attrib_label le nom de l'attribut.
     * @param attrib_values les valeurs du tableau ou de la collection portés
     * par l'attribut.
     */
    public void addAttributeList(String attrib_label,
            Vector<Object> attrib_values) {
        addObjectAttributeList(attrib_label, attrib_values);
    }

    /**
     * Ajoute à l'interface du navigateur, un composant graphique représentant
     * le contenu d'un tableau ou d'une collection.
     * @param attrib_objects un vecteur contenant l'ensemble des valeurs de
     * l'objet de type tableau ou collection.
     */
    public void addObjectAttributeList(Vector<Object> attrib_objects) {
        addObjectAttributeList(this.i18nLanguageFile.getString(
        "DefaultCollectionClassesContentLabel"), attrib_objects, //$NON-NLS-1$
        1, ""); //$NON-NLS-1$
    }

    /**
     * Ajoute à l'interface du navigateur, un composant graphique représentant
     * le contenu d'un attribut de type tableau ou collection.
     * @param attrib_label le nom de l'attribut.
     * @param attrib_objects les valeurs du tableau ou de la collection portés
     * par l'attribut.
     */
     ...
     * @param attrib_underlyingType le type du contenu du tableau ou de la
     * collection.
     */
    public void addObjectAttributeList(
            String attrib_label,
        ...
        for (int i = 0; i < NbElemAttribList; i++) {
            ...
            if (isTextPrintableField) {
                ...
                formatter.applyPattern(
                        this.i18nLanguageFile.getString(
                        "AttributeToolTipLabel")); //$NON-NLS-1$
                object_button.setToolTipText(formatter.format(msgArguments));

                object_button.addActionListener(
                        new ObjectBrowserAttributeListener(
                                attrib_objects.get(i)));
                attribListPanel.add(object_button);
                if (i < NBVISIBLEROW) {
                    prefHeight += 1 + object_button.getPreferredSize()
                    .getHeight();
        ...
        attribPane.setPreferredSize(new Dimension((int) (prefWidthMax + 50),
                (int) (prefHeight + 3)));
     ...
     * une méthode.
     *
     * @param obj l'objet portant la méthode à représenter au sein de
     * l'interface du navigateur d'objet de GeOxygene.
    ...
    /**
     * @return l'objet dont l'interface courante du navigateur d'objet de
     * GeOxygene est la représentation.
     */
    ...
    /**
     * @return le RessourceBundle lié à la Locale et au fichier
