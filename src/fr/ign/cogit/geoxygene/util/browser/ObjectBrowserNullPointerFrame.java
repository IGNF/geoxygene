...
/**
 * Cette classe permet l'affichage d'une fenêtre graphique contenant un message d'avertissement lorsqu'un accès à une valeur <b>null</b> est tent�
 * ou qu'une telle valeur est renvoyée par une méthode d�clench�e depuis le navigateur d'objet graphique de GeOxygene.
 *
...
public class ObjectBrowserNullPointerFrame extends JFrame {
	...
	public ObjectBrowserNullPointerFrame() throws HeadlessException {
		...
		setTitle(i18nLanguageFile.getString("NullPointerFrameDefaultTitle"));

		try {
			URL imageUrl =
				this.getClass().getResource("images/exclamation.gif");

			JLabel nullPointerLabel = new JLabel(i18nLanguageFile.getString("NullPointerFrameDefaultLabel"),new ImageIcon(imageUrl),SwingConstants.CENTER);
