...
public class ParseException extends Exception {
  ...
  public ParseException(Token currentTokenVal,
    ...
    super(ParseException.initialise(currentTokenVal, expectedTokenSequencesVal,
        tokenImageVal));
  ...
  public String getMessage() {
    ...
    for (int[] expectedTokenSequence : this.expectedTokenSequences) {
      ...
      for (int j = 0; j < expectedTokenSequence.length; j++) {
        expected.append(this.tokenImage[expectedTokenSequence[j]]).append(' ');
      }
  ...
  private static String initialise(Token currentToken,
    ...
    for (int i = 0; i < maxSize; i++) {
      ...
      retval += " \"";
      retval += ParseException.addEscapes(tok.image);
      retval += " \"";
      tok = tok.next;
    }
...
/*
 * JavaCC - OriginalChecksum=70af492f69879096afaea1624455b59c (do not edit this
 * line)
 */
