...
public class TestLib {
    ...
    private FT_FeatureCollection featureList1, featureList2;  // result du chargement 
    private GM_MultiSurface aggr1; // agregat geometrique issu du chargement
    private GM_MultiSurface aggr2; // agregat geometrique issu du chargement
    ...
    public void testAll() {
         ...
         featureList1 = db.loadAllFeatures(featureClass1);
         featureList2 = db.loadAllFeatures(featureClass2);
         System.out.println("chargement termine");

         // Constitution des agregats
         featureList1.initIterator();
         while (featureList1.hasNext())  aggr1.add(featureList1.next().getGeom());
         featureList2.initIterator();
         while (featureList2.hasNext())  aggr2.add(featureList2.next().getGeom());
