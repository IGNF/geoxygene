...
public class StringOperation {
  ...
  private static final Vector<String> map = StringOperation.initMap();
  ...
  public static java.lang.String sansAccent(java.lang.String chaine) {
    ...
    for (int bcl = 0; bcl < Result.length(); bcl++) {
      ...
      if (carVal >= StringOperation.MIN && carVal <= StringOperation.MAX) { // Remplacement
        java.lang.String newVal = StringOperation.map.get(carVal
            - StringOperation.MIN);
