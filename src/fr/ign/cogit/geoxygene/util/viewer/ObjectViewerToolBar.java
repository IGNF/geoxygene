...
class ObjectViewerToolBar extends JToolBar {
  ...
  public ObjectViewerToolBar(ObjectViewerInterface objectViewerInterface,
      boolean openFileTool, boolean zoomInTool, boolean zoomOutTool,
      boolean zoomExtentTool, boolean panTool, boolean fullExtentTool,
      boolean selectionTool, Geodatabase db) {
    ...
    if (openFileTool) {
      ...
      final JToggleButton opentbutton = new JToggleButton(openicon, false);
      opentbutton.setToolTipText("Open a file");
      opentbutton.addActionListener(new GeOxygeneViewerOpenFileAction(
    ...
    if (db != null) {
      ...
      final JToggleButton geOxygenetbutton = new JToggleButton(geOxygeneIcon,
          false);
      geOxygenetbutton.setToolTipText("Access to GeOxygene mapping repository");
      geOxygenetbutton
          .addActionListener(new GeOxygeneViewerOpenGeOxygeneAction(
    ...
    if (zoomInTool) {
      ...
      zoomintbutton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          ObjectViewerToolBar.this.getObjectViewerInterface().view
              .setTool(zoomintool);
        }
      });
    ...
    if (zoomExtentTool) {
      ...
      // final JToggleButton zoomextenttbutton = new
      // JToggleButton(zoomextenticon,false);
      final JToggleButton zoomextenttbutton = new JToggleButton(zoomextenticon,
          true);
      ...
      zoomextenttbutton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          System.out.println("Zoom In/Out to extent tool selected !!!");
    ...
    if (zoomInTool || zoomOutTool || zoomExtentTool || panTool
        || fullExtentTool) {
      this.addSeparator();
    }
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (selectedObjects != null) {
            for (int i = 0; i < selectedObjects.size(); i++) {
              ObjectViewerInterface.ObjectsIDAndSource aSelectedObjectAndSource = selectedObjects
                  .get(i);
              if (aSelectedObjectAndSource.getDataSource() instanceof GeOxygeneReader) {
                GeOxygeneReader geOxyRd = (GeOxygeneReader) aSelectedObjectAndSource
                    .getDataSource();
  ...
  public ObjectViewerToolBar(ObjectViewerInterface objectViewerInterface,
      Geodatabase db) {
    this(objectViewerInterface, ObjectViewerToolBar.IS_OPENFILETOOL_SELECTED,
        ObjectViewerToolBar.IS_ZOOMINTOOL_SELECTED,
        ObjectViewerToolBar.IS_ZOOMOUTTOOL_SELECTED,
        ObjectViewerToolBar.IS_ZOOMEXTENTTOOL_SELECTED,
        ObjectViewerToolBar.IS_PANTOOL_SELECTED,
        ObjectViewerToolBar.IS_FULLEXTENTTOOL_SELECTED,
        ObjectViewerToolBar.IS_SELECTIONTOOL_SELECTED, db);
  }
