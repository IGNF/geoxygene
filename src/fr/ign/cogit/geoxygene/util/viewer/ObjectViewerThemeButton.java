...
class ObjectViewerThemeButton extends JToggleButton {
  ...
  public ObjectViewerThemeButton(ObjectViewerInterface objectViewerInterface,
      ObjectViewerThemeProperties themeProp) {
    ...
    this.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        if (ObjectViewerThemeButton.this.getThemeProperties().isActive()) {
          ...
          ObjectViewerThemeButton.this.getObjectViewerInterface()
              .getActiveThemes().remove(theme);
          ObjectViewerThemeButton.this.getThemeProperties().setActive(false);
          theme.setSelectionManager(null);
          theme.setHighlightManager(null);
        } else {
          // System.out.println("Theme pressed !");
          ObjectViewerThemeButton.this.getObjectViewerInterface()
              .getActiveThemes().add(theme);
          ObjectViewerThemeButton.this.getThemeProperties().setActive(true);
          theme.setSelectionManager(ObjectViewerThemeButton.this
              .getThemeProperties().getThemeSelectionManager());
          theme.setHighlightManager(ObjectViewerThemeButton.this
              .getThemeProperties().getThemeHighlightManager());
        }
      }
    });
