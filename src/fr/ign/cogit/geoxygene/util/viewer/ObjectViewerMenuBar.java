...
class ObjectViewerMenuBar extends JMenuBar {
	...
	public ObjectViewerMenuBar(ObjectViewerInterface objectViewerInterface, Geodatabase db) {
		...
		item.addActionListener(new GeOxygeneViewerOpenFileAction(objectViewerInterface));
		file.add(item);

		// Item "GeOxygene"
		if (db != null) {
			item = new JMenuItem("GeOxygene");
			item.addActionListener(new GeOxygeneViewerOpenGeOxygeneAction(objectViewerInterface,db));
			file.add(item);
		}
		...
		item.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				getObjectViewerInterface().dispose();
			}
		});
		file.add(item);
