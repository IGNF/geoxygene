...
public class Legende {
	...
	public static double getECHELLE_SYMBOLISATION() {return ECHELLE_SYMBOLISATI0N;}
	public static void setECHELLE_SYMBOLISATION(double echelle_cible) {ECHELLE_SYMBOLISATI0N = echelle_cible;}
