...
/**
 * Classe mère pour les métaclasses de propriétés définissant les
 * caractéristiques des classes Géographiques Feature Types ou des associations
 * Association Types. (opérations, attributs, rôles dans une associations).
 * 
