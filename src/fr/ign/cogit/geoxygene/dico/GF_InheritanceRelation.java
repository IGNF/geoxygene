...
/**
 * Classe générique pour traduire les relations d'héritage (généralisation /
 * spécialisation).
 * 
...
public class GF_InheritanceRelation {
  ...
  public List<GF_FeatureType> getSuperType() {
    return this.superType;
  }

  /** Affecte une liste de classes meres */
  public void setSuperType(List<GF_FeatureType> L) {
    this.superType = L;
  }

  /** Nombre de classes meres de la relation d'héritage. */
  public int sizeSuperType() {
    return this.superType.size();
  }
