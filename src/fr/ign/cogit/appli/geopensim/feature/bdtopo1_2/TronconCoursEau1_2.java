...
public class TronconCoursEau1_2 extends TronconCoursEau {
	/**
	...
	protected long artif;
	public long getArtif() {return this.artif; }
	public void setArtif (long Artif) {artif = Artif; }

	protected long fictif;
	public long getFictif() {return this.fictif; }
	public void setFictif (long Fictif) {fictif = Fictif; }
	...
	/* (non-Javadoc)
	 * @see fr.ign.cogit.appli.geopensim.feature.micro.TronconCoursEau#qualifier()
	 */
	@Override
