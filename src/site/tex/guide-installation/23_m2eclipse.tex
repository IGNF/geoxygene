...
\smallskip
\begin{center}
\includegraphics[width=0.4\linewidth]{m2eclipseUrl}
\end{center}

\noindent
2. A l'étape 4 choisir l'unique composant "Maven Integration for Eclipse".\\
\begin{center}
\includegraphics[width=0.4\linewidth]{m2eclipseEtape1}
\end{center}
...
\smallskip
\begin{center}
\includegraphics[width=0.4\linewidth]{m2eclipseExtrasUrl}
\end{center}

\noindent
2. A l'étape 4 sélectionner au moins le composant "Maven SCM handler for Subclipse".\\
\begin{center}
\includegraphics[width=0.4\linewidth]{m2eclipseExtrasEtape1}
\end{center}
