...
set MAIN="fr.ign.cogit.geoxygene.appli.GeOxygeneApplication"

set JARS=.
set CLASSPATH=
for %%i in (.\lib\*.jar) do call cpappend.bat %%i
set CLASSPATH=%JARS%;./conf;geoxygene-appli-1.6.jar;
REM echo %CLASSPATH%
 
%JAVA% "%JAVA_MAXMEM%" "%GEOX_OPTS%" -cp %CLASSPATH% fr.ign.cogit.geoxygene.appli.GeOxygeneApplication
