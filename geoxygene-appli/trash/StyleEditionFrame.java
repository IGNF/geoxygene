...
public class StyleEditionFrame extends JDialog implements ActionListener,
    ...
    public StyleEditionFrame(LayerLegendPanel layerLegendPanel) {
        ...
        DataSet dataset = layerLegendPanel.getLayerViewPanel()
    ...
    public JPanel createToponymPanel() {
        ...
        JLabel label = new JLabel(
                I18N.getString("StyleEditionFrame.DisplayField")); //$NON-NLS-1$
        ...
        if (this.layer.getFeatureCollection().getFeatureType() != null) {
            ...
            for (int i = 0; i < fieldsStr.length; i++) {
                fieldsStr[i] = this.layer.getFeatureCollection()
                        .getFeatureType().getFeatureAttributes().get(i)
                        .getMemberName();
            }
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (StyleEditionFrame.this.symbolizer != null
                        ...
                        StyleEditionFrame.this.symbolizer
                                .setLabel(((JComboBox) e.getSource())
    ...
    protected void enableToponyms() {
        ...
        if (StyleEditionFrame.this.featureTypeStyle == null) {
            Style lastStyle = layer.getStyles().get(
                    layer.getStyles().size() - 1);
        ...
        this.symbolizer.getFill()
                .setFill(this.textPreviewLabel.getForeground());
    ...
    private void createTextSymbolizer() {
        ...
        if (this.layer.getFeatureCollection().getFeatureType() != null) {
            Class<? extends IGeometry> geomType = this.layer
    ...
    protected void disableToponyms() {
        StyleEditionFrame.this.featureTypeStyle.getRules().get(0)
                .getSymbolizers().remove(this.symbolizer);
    }
    ...
    public JPanel createPlacementPanel() {
        ...
        placementPanel
                .setLayout(new BoxLayout(placementPanel, BoxLayout.Y_AXIS));
        // create the title
        TitledBorder fillTitleBorder = BorderFactory.createTitledBorder(""); //$NON-NLS-1$
        fillTitleBorder.setTitleColor(Color.blue);
        fillTitleBorder.setTitleFont(new Font("Verdana", Font.BOLD, 16)); //$NON-NLS-1$
        ...
        JLabel label = new JLabel(
                I18N.getString("StyleEditionFrame.PlacementType")); //$NON-NLS-1$
        ...
        this.repeatBtn = new JCheckBox(
                I18N.getString("StyleEditionFrame.Repeat")); //$NON-NLS-1$
    ...
    public JPanel createFontPanel() {
        ...
        if (this.symbolizer != null) {
            this.textPreviewLabel
                    .setFont(this.symbolizer.getFont().toAwfFont());
            this.textPreviewLabel.setForeground(this.symbolizer.getFill()
                    .getFill());
        } else {
        ...
        styleFontCombo.setSelectedIndex(this.textPreviewLabel.getFont()
                .getStyle());
        ...
        styleFontCombo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                StyleEditionFrame.this.layerLegendPanel.getModel()
        ...
        sizeFontCombo.setSelectedItem(((Integer) this.textPreviewLabel
        ...
        sizeFontCombo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Font newFont = new Font(StyleEditionFrame.this.textPreviewLabel
                        .getFont().getFamily(),
                        StyleEditionFrame.this.textPreviewLabel.getFont()
                                .getStyle(), Integer.parseInt(((JComboBox) e
        ...
        JButton colorButton = new JButton(
                I18N.getString("StyleEditionFrame.Color")); //$NON-NLS-1$
        colorButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                logger.info(c);
                if (StyleEditionFrame.this.symbolizer != null) {
                    logger.info(StyleEditionFrame.this.symbolizer.getFill()
                            .getFill());
                    StyleEditionFrame.this.symbolizer
                            .setFont(new fr.ign.cogit.geoxygene.style.Font(
                                    StyleEditionFrame.this.textPreviewLabel
                                            .getFont()));
                ...
                StyleEditionFrame.this.layerViewPanel.getProjectFrame()
                        .repaint();
            }
        });
    ...
    public void initLine() {
        ...
        this.strokeWidth = ((LineSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getStroke().getStrokeWidth();
        this.strokeLineJoin = ((LineSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getStroke().getStrokeLineJoin();
        this.strokeLineCap = ((LineSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getStroke().getStrokeLineCap();
        this.unit = ((LineSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getUnitOfMeasure();
        ...
        if (this.layer.getStyles().size() == 2) {
            ...
            TitledBorder strokeTitleBorder2 = BorderFactory
            ...
            this.strokeColor2 = ((LineSymbolizer) this.layer.getStyles().get(1)
                    .getSymbolizer()).getStroke().getStroke();
            this.strokeOpacity2 = ((LineSymbolizer) this.layer.getStyles()
                    .get(1).getSymbolizer()).getStroke().getStrokeOpacity();
            this.strokeWidth2 = ((LineSymbolizer) this.layer.getStyles().get(1)
                    .getSymbolizer()).getStroke().getStrokeWidth();

            this.strokePanel2.add(this.createColorPreviewPanel(
                    this.strokeColor2, this.strokeOpacity2));
            this.strokePanel2.add(this.createWidthPanel(this.strokeWidth2,
                    this.unit));
            this.strokePanel2.add(this.createJoinCapPanel(this.strokeLineJoin,
                    this.strokeLineCap));
        } else {
            this.strokePanel2 = new JPanel();
    ...
    public void initPoint() {
        ...
        this.strokeWidth = ((PointSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getGraphic().getMarks().get(0).getStroke()
                .getStrokeWidth();
        this.strokeLineJoin = ((PointSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getGraphic().getMarks().get(0).getStroke()
                .getStrokeLineJoin();
        this.strokeLineCap = ((PointSymbolizer) this.layer.getStyles().get(0)
                .getSymbolizer()).getGraphic().getMarks().get(0).getStroke()
                .getStrokeLineCap();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.addColorMapButton) {
            ...
            String attributeName = ((GF_AttributeType) JOptionPane
                    .showInputDialog(
                            this,
                            ...
                            attributes.get(0).toString())).getMemberName();
            ...
            if ((attributeName != null) && (attributeName.length() > 0)) {
                ...
                if (this.layer.getSymbolizer().isPolygonSymbolizer()) {
                    PolygonSymbolizer ps = (PolygonSymbolizer) this.layer
                            .getSymbolizer();
                    ps.setColorMap(cm);
                    ps.setFill(null);
                    return;
                } else if (this.layer.getSymbolizer().isLineSymbolizer()) {
                    LineSymbolizer ls = (LineSymbolizer) this.layer
                            .getSymbolizer();
                    ls.setColorMap(cm);
                    return;
                } else if (this.layer.getSymbolizer().isPointSymbolizer()) {
                    PointSymbolizer pts = (PointSymbolizer) this.layer
                            .getSymbolizer();
                    pts.setColorMap(cm);
                    return;
                }
        ...
        if (e.getSource().getClass() != JComboBox.class
            ...
            if (((JButton) e.getSource()).getActionCommand() == "OK") { //$NON-NLS-1$
                ...
                if (dialog == this.strokeDialog2) {
                    ...
                    g2.fillRect(0, 0, 50, 40);
                    g2.setColor(new Color(
                            (float) this.strokeColor2.getRed() / 255,
                            (float) this.strokeColor2.getGreen() / 255,
                            (float) this.strokeColor2.getBlue() / 255,
                            this.strokeOpacity2));
                    g2.fillRect(0, 0, 50, 40);
                    this.strokeFinalColorLabel2.setIcon(new ImageIcon(
                            buffImFinalColor));
                }
                this.updateLayer();
            }
    ...
    public void stateChanged(ChangeEvent arg0) {
        ...
        if (arg0.getSource() == this.strokeOpacitySlider2) {
            ...
            g2.setColor(new Color((float) this.strokeColor2.getRed() / 255,
                    ...
                    this.strokeOpacity2));
            g2.fillRect(0, 0, 50, 40);
            this.strokeFinalColorLabel2
                    .setIcon(new ImageIcon(buffImFinalColor));
    ...
    public void updateLayer() {
        ...
        this.layerLegendPanel.getModel().setBackground(
                this.getInitialSLD().getBackground());
        ...
        if (symbolizer.isPolygonSymbolizer()) {
            ...
            polygonSymbolizer.getStroke().setStrokeWidth(
            ...
            if (this.layer.getStyles().size() == 2) {
                ...
                lineSymbolizer2.getStroke().setStrokeOpacity(
                        this.strokeOpacity2);
                lineSymbolizer2.getStroke().setStrokeWidth(
                        (float) this.strokeWidth2);
