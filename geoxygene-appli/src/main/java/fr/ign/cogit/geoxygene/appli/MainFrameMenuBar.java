    ...
    private void initFileMenu() {
        ...
        loadSLDMenuItem.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                int result = chooser.showOpenDialog(MainFrameMenuBar.this.mainFrame.getGui());
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (file != null) {
                        ...
                        try {
                            ...
                            MainFrameMenuBar.this.mainFrame.getApplication().getProperties().setLastOpenedFile(file.getAbsolutePath());
        ...
        saveAsSLDMenuItem.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                JFileChooser chooser = new JFileChooser(MainFrameMenuBar.this.mainFrame.getApplication().getProperties().getLastOpenedFile());
                int result = chooser.showSaveDialog(MainFrameMenuBar.this.mainFrame.getGui());
                if (result == JFileChooser.APPROVE_OPTION) {
                    File file = chooser.getSelectedFile();
                    if (file != null) {
                ...
                Thread th = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            JOptionPane.showMessageDialog(MainFrameMenuBar.this.mainFrame.getSelectedProjectFrame().getLayerViewPanel(),
