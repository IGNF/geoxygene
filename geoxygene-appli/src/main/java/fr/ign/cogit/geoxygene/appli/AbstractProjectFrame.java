...
public abstract class AbstractProjectFrame implements ProjectFrame {
  ...
  /**
   * @param layerViewPanel the layerViewPanel to set
   */
  ...
  /**
   * @param layerLegendPanel the layerLegendPanel to set
   */
  ...
  public final void askAndAddNewLayer() {
    File file = MainFrameMenuBar.fc.getFile(this.getMainFrame().getGui());
    this.addLayer(file);
  }
   ...
   * (non-Javadoc)
   * 
   * @see fr.ign.cogit.geoxygene.appli.ProjectFrame#saveAsShp(java.lang.String,
  ...
  /**
   * SCH load the described styles in an xml file and apply them to a predefined
   * dataset.
   * 
   ...
   * (non-Javadoc)
   * 
   * @see fr.ign.cogit.geoxygene.appli.ProjectFrame#removeLayers(java.util.List)
   */
  @Override
