...
public class FloatingProjectFrame extends AbstractProjectFrame implements
   ...
   */
  public FloatingProjectFrame(final MainFrame frame,
  ...
  public JInternalFrame getInternalFrame() {
    if (this.internalFrame == null) {
      this.internalFrame = new JInternalFrame(this.getTitle(), true, true,
          true, true);
      ...
      this.internalFrame.setSize(FloatingProjectFrame.DEFAULT_WIDTH,
          FloatingProjectFrame.DEFAULT_HEIGHT);
      ...
      this.internalFrame.getContentPane().add(this.getSplitPane(),
          BorderLayout.CENTER);
  ...
  public void setGeometryToolsVisible(boolean b) {
    ...
    if (b) {
      this.getInternalFrame().getContentPane()
