...
/**
 * @author JeT
 *         Add parameterization to geometry
 */
public abstract class ParameterizedGeometry implements Parameterization {
     ...
     */
    public final void setParameterizer(Parameterizer parameterizer) {
