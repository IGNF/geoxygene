...
import fr.ign.cogit.geoxygene.appli.plugin.cartagen.util.CartAGenProgressBar;
...
public class DatasetGeoxGUIComponent extends JMenu {
  ...
  /**
   * Action that propose to add a layer that is filled in the dataset but not in
   * the layerViewPanel.
   * 
   * @author GTouya
   * 
