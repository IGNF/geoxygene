 ...
 */
public class MainFrameToolBar implements ContainerListener, KeyListener, MouseListener, MouseWheelListener, MouseMotionListener {

    /** Logger. */
    static final Logger LOGGER = Logger.getLogger(MainFrameToolBar.class.getName());
    ...
    public MainFrameToolBar(final MainFrame theMainFrame) {
        ...
        // ZoomToFullExtent
        ImageIcon zoomToFullExtentIcon = new ImageIcon(MainFrameToolBar.class.getResource("/images/toolbar/zoomToFullExtent.png"));
        ...
        zoomToFullExtentButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ProjectFrame projectFrame = MainFrameToolBar.this.getMainFrame().getSelectedProjectFrame();
        ...
        zoomToFullExtentButton.setToolTipText(I18N.getString("ModeSelector.zoomToFullExtent.ToolTip")); //$NON-NLS-1$
        ...
        // Refresh
        JButton refreshButton = new JButton(new ImageIcon(MainFrameToolBar.class.getResource("/images/toolbar/refresh.png"))); //$NON-NLS-1$
        refreshButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (projectFrame != null) {
                    // refresh symbolizers
                    for (Layer layer : projectFrame.getLayers()) {
                        TextureManager.getInstance().invalidateTextures(layer);
                    }
                    projectFrame.getLayerViewPanel().repaint();
                }
            }
        });
        refreshButton.setToolTipText(I18N.getString("ModeSelector.refresh.ToolTip")); //$NON-NLS-1$
        ...
        final JToggleButton showGeometryToolsButton = new JToggleButton(new ImageIcon(MainFrameToolBar.class.getResource("/images/icons/16x16/edit.png"))); //$NON-NLS-1$
        ...
        showGeometryToolsButton.setToolTipText(I18N.getString("ModeSelector.showGeometryTools.ToolTip")); //$NON-NLS-1$
        this.toolBar.add(showGeometryToolsButton);

        this.toolBar.addSeparator();

        JButton newTabButton = new JButton(new ImageIcon(MainFrameToolBar.class.getResource("/images/icons/tab_add.png"))); //$NON-NLS-1$
        ...
        JButton newProjectFrameButton = new JButton(new ImageIcon(MainFrameToolBar.class.getResource("/images/icons/application_add.png"))); //$NON-NLS-1$
    ...
    public final void componentAdded(final ContainerEvent e) {
        ProjectFrame projectFrame = this.getMainFrame().getProjectFrameFromGui(e.getChild());
