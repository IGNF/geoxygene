...
import fr.ign.cogit.geoxygene.appli.plugin.cartagen.util.RangeSlider;
...
public class RangeSliderUI extends BasicSliderUI {
  ...
  protected void calculateThumbLocation() {
    ...
    if (this.slider.getOrientation() == SwingConstants.HORIZONTAL) {
      int upperPosition = this
          .xPositionForValue(this.slider.getValue() + this.slider.getExtent());
      this.upperThumbRect.x = upperPosition - (this.upperThumbRect.width / 2);
      this.upperThumbRect.y = this.trackRect.y;

    } else {
      int upperPosition = this
          .yPositionForValue(this.slider.getValue() + this.slider.getExtent());
  ...
  public void scrollByBlock(int direction) {
    synchronized (this.slider) {
      int blockIncrement = (this.slider.getMaximum() - this.slider.getMinimum())
          / 10;
      if (blockIncrement <= 0
      ...
      int delta = blockIncrement * ((direction > 0)
          ? BasicSliderUI.POSITIVE_SCROLL : BasicSliderUI.NEGATIVE_SCROLL);
    ...
    public void mousePressed(MouseEvent e) {
      ...
      if (RangeSliderUI.this.upperThumbSelected) {
        ...
        if (RangeSliderUI.this.thumbRect.contains(this.currentMouseX,
            this.currentMouseY)) {
          lowerPressed = true;
        } else if (RangeSliderUI.this.upperThumbRect
            .contains(this.currentMouseX, this.currentMouseY)) {
          upperPressed = true;
        }
      }
    ...
    private void moveLowerThumb() {
      ...
      switch (RangeSliderUI.this.slider.getOrientation()) {
        case SwingConstants.VERTICAL:
          ...
          RangeSliderUI.this.slider
              .setValue(RangeSliderUI.this.valueForYPosition(thumbMiddle));
          break;
        ...
        case SwingConstants.HORIZONTAL:
          ...
          RangeSliderUI.this.slider
              .setValue(RangeSliderUI.this.valueForXPosition(thumbMiddle));
          break;
    ...
    private void moveUpperThumb() {
      ...
      switch (RangeSliderUI.this.slider.getOrientation()) {
        case SwingConstants.VERTICAL:
          ...
          thumbMiddle = thumbTop + halfThumbHeight;
          RangeSliderUI.this.slider
              .setExtent(RangeSliderUI.this.valueForYPosition(thumbMiddle)
        ...
        case SwingConstants.HORIZONTAL:
          ...
          thumbMiddle = thumbLeft + halfThumbWidth;
          RangeSliderUI.this.slider
              .setExtent(RangeSliderUI.this.valueForXPosition(thumbMiddle)
                  - RangeSliderUI.this.slider.getValue());
          break;
