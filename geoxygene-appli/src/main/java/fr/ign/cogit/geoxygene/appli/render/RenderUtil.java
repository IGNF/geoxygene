...
public final class RenderUtil {
        ...
        if (fillColor != null && fillOpacity > 0f) {
            ...
            for (Shape shape : shapes) {
                ...
                if (symbolizer.getFill().getGraphicFill() != null) {
                    ...
                    texturePolygon(
                            (TextureDescriptor) (symbolizer.getFill().getFill2DDescriptor()),
    ...
    private static void texturePolygon(TextureDescriptor texture,
            IFeature feature, Shape shape, Viewport viewport, Graphics2D graphics,
        ...
        // }
        BufferedImage imgTexture = TextureManager.getInstance().getTextureImage(
                String.valueOf(feature.getId()), texture,
