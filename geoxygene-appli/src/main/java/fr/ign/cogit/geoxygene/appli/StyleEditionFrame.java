 ...
 */
public class StyleEditionFrame extends JDialog implements ActionListener, MouseListener, ChangeListener, ItemListener {
    ...
    private final String[] symbolsDescription = { I18N.getString("StyleEditionFrame.Square"), //$NON-NLS-1$
    ...
    public StyleEditionFrame(LayerLegendPanel layerLegendPanel) {
        ...
        this.addPrimitiveRendererUI(); // see method comments to know what it is
    ...
    private void addPrimitiveRendererUI() {
        if (this.tabPane == null) {
            throw new IllegalStateException("this method can only be called after tabPane creation");
        }
        RenderingManager renderingManager = this.layerViewPanel.getRenderingManager();
    ...
    public void initTextStylePanel() {
        ...
        Style lastStyle = this.layer.getStyles().get(this.layer.getStyles().size() - 1);
    ...
    private void createTextSymbolizer() {
        ...
        if (this.layer.getFeatureCollection().getFeatureType() != null) {
            Class<? extends IGeometry> geomType = this.layer.getFeatureCollection().getFeatureType().getGeometryType();
        ...
        this.symbolizer.setFont(new fr.ign.cogit.geoxygene.style.Font(new Font("Verdana", Font.BOLD, 12))); //$NON-NLS-1$
        this.symbolizer.setFill(new Fill());
    ...
    public JPanel createFontPanel() {
        ...
        familyFontCombo.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Font newFont = new Font(((JComboBox) e.getSource()).getSelectedItem().toString(), StyleEditionFrame.this.textPreviewLabel.getFont().getStyle(),
        ...
        styleFontCombo.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Font newFont = new Font(StyleEditionFrame.this.textPreviewLabel.getFont().getFamily(), ((JComboBox) e.getSource()).getSelectedIndex(),
                        StyleEditionFrame.this.textPreviewLabel.getFont().getSize());
                StyleEditionFrame.this.textPreviewLabel.setFont(newFont);
                if (StyleEditionFrame.this.symbolizer != null) {
                    StyleEditionFrame.this.symbolizer.setFont(new fr.ign.cogit.geoxygene.style.Font(newFont));
        ...
        sizeFontCombo.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Font newFont = new Font(StyleEditionFrame.this.textPreviewLabel.getFont().getFamily(), StyleEditionFrame.this.textPreviewLabel.getFont()
                        .getStyle(), Integer.parseInt(((JComboBox) e.getSource()).getSelectedItem().toString()));
                StyleEditionFrame.this.textPreviewLabel.setFont(newFont);
                if (StyleEditionFrame.this.symbolizer != null) {
                    StyleEditionFrame.this.symbolizer.setFont(new fr.ign.cogit.geoxygene.style.Font(newFont));
                }
        ...
        colorButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Color c = COGITColorChooserPanel.showDialog(new JButton(), I18N.getString("StyleEditionFrame.PickAColor"), //$NON-NLS-1$
    ...
    public void initPolygon() {
        ...
        PolygonSymbolizer symbolizer = (PolygonSymbolizer) this.layer.getStyles().get(0).getSymbolizer();
        ...
        this.addCategorizedMapButton = new JButton(I18N.getString("StyleEditionFrame.AddCategorizedMap")); //$NON-NLS-1$
    ...
    public void initLine() {
        ...
        this.btnAddStyle = new JButton(I18N.getString("StyleEditionFrame.AddAStyle")); //$NON-NLS-1$
    ...
    public JPanel createColorPreviewPanel(Color c, float transparency) {
        ...
        colorPreviewPanel.add(this.createFinalColorPanel(new Color((float) c.getRed() / 255, (float) c.getGreen() / 255, (float) c.getBlue() / 255,
                transparency)));
    ...
    public JPanel createJoinCapPanel(int joinValue, int capValue) {
        ...
        panel.add(leftPanel);
        StrokeSamplePanel strokeSample = new StrokeSamplePanel(joinValue, capValue);
    ...
    public JPanel createSymbolPanel(String shape) {
        ...
        for (int i = 0; i < this.symbols.length; i++) {
            ...
            this.images[i] = new ImageIcon(this.getClass().getResource("/images/shapes/" + this.symbols[i] + ".png")); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.addColorMapButton) {
            ...
            String attributeName = ((GF_AttributeType) JOptionPane.showInputDialog(this, I18N.getString("StyleEditionFrame.ChooseAttribute"), //$NON-NLS-1$
                    I18N.getString("StyleEditionFrame.ChooseAttributeWindowTitle"), //$NON-NLS-1$
                    JOptionPane.PLAIN_MESSAGE, null, possibilities, attributes.get(0).toString())).getMemberName();
        ...
        if (e.getSource() == this.btnAddStyle) {
            ...
            try {
                sld = StyledLayerDescriptor.unmarshall(StyledLayerDescriptor.class.getClassLoader().getResourceAsStream("sld/BasicStyles.xml"));
        ...
        if (e.getSource().getClass() != JComboBox.class && e.getSource().getClass() != JRadioButton.class && e.getSource().getClass() != JCheckBox.class) {
            if (((JButton) e.getSource()).getActionCommand() == "OK") { //$NON-NLS-1$
                ...
                if (dialog == this.fillDialog) {
                    ...
                    g2.setColor(new Color((float) this.fillColor.getRed() / 255, (float) this.fillColor.getGreen() / 255,
                ...
                if (dialog == this.strokeDialog) {
                    ...
                    g2.setColor(Color.white);
                    g2.fillRect(0, 0, 50, 40);
                    g2.setColor(new Color((float) this.strokeColor.getRed() / 255, (float) this.strokeColor.getGreen() / 255, (float) this.strokeColor
                ...
                if (dialog == this.strokeDialog2) {
                    ...
                    g2.setColor(Color.white);
                    g2.fillRect(0, 0, 50, 40);
                    g2.setColor(new Color((float) this.strokeColor2.getRed() / 255, (float) this.strokeColor2.getGreen() / 255, (float) this.strokeColor2
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        if (arg0.getSource() == this.fillColorLabel) {
            ...
            this.fillDialog = JColorChooser.createDialog(this, I18N.getString("StyleEditionFrame.PickAColor"), //$NON-NLS-1$
        ...
        if (arg0.getSource() == this.strokeColorLabel) {
            ...
            this.strokeDialog = JColorChooser.createDialog(this, I18N.getString("StyleEditionFrame.PickAColor"), //$NON-NLS-1$
        ...
        if (arg0.getSource() == this.strokeColorLabel2) {
            ...
            this.strokeDialog2 = JColorChooser.createDialog(this, I18N.getString("StyleEditionFrame.PickAColor"), //$NON-NLS-1$
    ...
    public void stateChanged(ChangeEvent arg0) {
        ...
        if (arg0.getSource() == this.fillOpacitySlider) {
            ...
            g2.setColor(Color.white);
            g2.fillRect(0, 0, 50, 40);
            g2.setColor(new Color((float) this.fillColor.getRed() / 255, (float) this.fillColor.getGreen() / 255, (float) this.fillColor.getBlue() / 255,
                    this.fillOpacity));
            g2.fillRect(0, 0, 50, 40);
            this.fillFinalColorLabel.setIcon(new ImageIcon(buffImFinalColor));
        ...
        if (arg0.getSource() == this.strokeOpacitySlider) {
            ...
            g2.setColor(Color.white);
            g2.fillRect(0, 0, 50, 40);
            g2.setColor(new Color((float) this.strokeColor.getRed() / 255, (float) this.strokeColor.getGreen() / 255, (float) this.strokeColor.getBlue() / 255,
                    this.strokeOpacity));
            g2.fillRect(0, 0, 50, 40);
            this.strokeFinalColorLabel.setIcon(new ImageIcon(buffImFinalColor));
        ...
        if (arg0.getSource() == this.strokeOpacitySlider2) {
            ...
            g2.setColor(Color.white);
            g2.fillRect(0, 0, 50, 40);
            g2.setColor(new Color((float) this.strokeColor2.getRed() / 255, (float) this.strokeColor2.getGreen() / 255,
    ...
    public void getDialogElements() {
        if (this.layer.getStyles().get(0).getSymbolizer().isPolygonSymbolizer() || this.layer.getStyles().get(0).getSymbolizer().isLineSymbolizer()
            ...
            this.strokeOpacitySlider = (JSlider) ((JPanel) ((JPanel) ((JPanel) this.strokePanel.getComponent(0)).getComponent(0)).getComponent(1))
                    .getComponent(1);
