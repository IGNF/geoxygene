...
public class OutlineOperator extends AbstractDrawingPrimitiveOperator {
    ...
    private final List<DrawingPrimitive> primitives = new ArrayList<DrawingPrimitive>(); // primitives to outline
    ...
    /**
     * Set the awt stroke used to outline primitives. If set last, it do not use
     * Join, Cap and Width
     * 
     * @param awtStroke
     *            the awtStroke to set
     */
    ...
    private static DrawingPrimitive outline(final DrawingPrimitive primitive, final Stroke awtStroke) {
        ...
        //        List<Shape> shapes = primitive.getShapes();
        //
        //        Shape outline = awtStroke.createStrokedShape(shape);
        //        DrawingPrimitive outlinePrimitive = ParameterizedLineConverterUtil.generateParameterizedPolyline(outline);
