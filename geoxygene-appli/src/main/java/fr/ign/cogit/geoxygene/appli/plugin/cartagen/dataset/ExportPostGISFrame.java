    ...
    try {
      ...
      for (IFeature feature : featurePop) {
        ...
        for (int j = 0; j < mappingCurrentPop.size(); j++) {
          ...
          // get type
          String getter = "get" + javaAttr.substring(0, 1).toUpperCase()
          ...
          try {
            ...
            String getterbis = "is" + javaAttr.substring(0, 1).toUpperCase()
                + javaAttr.substring(1);
            try {
              ...
              try {
                ...
                logger.log(Level.SEVERE, "this method does not exist : "
                    + mapping.get(1) + "on the layer : " + layerName);
                // skip this attribute
                liste.add(null);
              }
            }
