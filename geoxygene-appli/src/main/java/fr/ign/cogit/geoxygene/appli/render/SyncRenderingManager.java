...
public class SyncRenderingManager implements RenderingManager {
   ...
   * @param renderingType in sync rendering manager only JOGL and LWJGL types
   *          are allowed
   */
      ...
      if (this.rendererMap.get(layer) == null) {
        ...
        switch (this.renderingType) {
          case LWJGL:
            ...
            break;
          default:
            logger.error("Cannot handle rendering type " + this.renderingType
