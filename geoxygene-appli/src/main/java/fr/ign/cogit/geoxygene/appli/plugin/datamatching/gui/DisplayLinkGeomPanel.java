 ...
 *
 */
public class DisplayLinkGeomPanel extends ProjectFrame {
    
    /** Default serial ID. */
    private static final long serialVersionUID = 1L;
    
    private EnsembleDeLiens liensReseaux;
    ...
    public DisplayLinkGeomPanel (MainFrame mf, EnsembleDeLiens liens) {
        ...
        super(mf, new ImageIcon(DisplayLinkPanel.class.getResource("/images/icons/application.png")));
    ...
    public void displayLink(String id) {
        try {
            ...
            // On nettoie
            System.out.println("Nb Layer a supprimer = " + getLayerLegendPanel().getLayerCount());
            for (int i = 0; i < getLayerLegendPanel().getLayerCount(); i++) {
                Layer layer = (Layer) getLayerLegendPanel().getLayer(i);
            ...
            while (itLiensReseaux.hasNext()) {
                ...
                if (Integer.toString(lienReseau.getId()).equals(id)) {
                    ...
                    Population<DefaultFeature> popArc = new Population<DefaultFeature>(false, "Lien", Lien.class, true);
                    ...
                    // Noeuds du reseau 1
                    addLayerNoeud(lienReseau.getNoeuds1(), "Noeud 1", new Color(11, 73, 157));
                    ...
                    while (itGroupes1.hasNext()) {
                        ...
                        addLayerNoeud(groupe1.getListeNoeuds(), "Noeud 1", new Color(11, 73, 157));
                    }
                    ...
                    // Noeuds du reseau 2
                    addLayerNoeud(lienReseau.getNoeuds2(), "Noeud 2", new Color(145, 100, 10));
                    ...
                    while (itGroupes2.hasNext()) {
                        ...
                        addLayerArc(groupe2.getListeArcs(), "Arc 2", new Color(145, 100, 10));
                        addLayerNoeud(groupe2.getListeNoeuds(), "Noeud 2", new Color(145, 100, 10));
                    }
    ...
    private void addLayerArc(List<Arc> listArc, String title, Color color) {
        ...
        Population<DefaultFeature> popArcReseau = new Population<DefaultFeature>(false, title, Arc.class, true);
        FeatureType newFeatureType = new FeatureType();
        ...
        while (itCorrespondant.hasNext()) {
            Arc arc = (Arc) itCorrespondant.next();
    ...
    private void addLayerNoeud(List<Noeud> listNoeud, String title, Color color) {
        ...
        Population<DefaultFeature> popNoeudReseau = new Population<DefaultFeature>(false, title, Noeud.class, true);
        FeatureType newFeatureType = new FeatureType();
        newFeatureType.setTypeName(title);
        ...
        PointSymbolizer pointSymbolizer = (PointSymbolizer) l.getStyles().get(0).getSymbolizer();
...
/*for (Lien lien : liens) {
// System.out.println("Id = " + lien.getId() + ", " + id);
if (Integer.toString(lien.getId()).equals(id)) {
    ...
    // Afficher les objets du reseau 1
    Population<DefaultFeature> popReseau1 = new Population<DefaultFeature>(false, "Reseau 1", Arc.class, true);
    ...
    popReseau1.setFeatureType(newFeatureType2);
    List<IFeature> objRef = lien.getObjetsRef();
    System.out.println("Nb liens correspondant = " + objRef.size());
    Iterator itCorrespondant = popReseau1.iterator();
    while (itCorrespondant.hasNext()) {
        Arc arc = (Arc) itCorrespondant.next();
        System.out.println("-" + arc.getGeom());
        popReseau1.add(arc);
    }
    Layer l1 = addUserLayer(popReseau1, "Correspondant", null);
