 ...
 * 
 */
public class IdentitySubshaderFilter implements Subshader {

    private static final Logger logger = Logger
            .getLogger(IdentitySubshaderFilter.class.getName()); // logger

    private static final String subshaderFilename = "./src/main/resources/shaders/filterIdentity.frag.glsl";

    public IdentitySubshaderFilter(LayerFilterIdentity filter) {
    }
