...
public interface RenderingManager {
     ...
     * 
     * @param layer
     *            the new layer to manage and render
     * @see Layer
     * @see AwtLayerRenderer
     */
    ...
    /**
     * finish RenderingManager execution before quitting Empty all cached
     * values. This method can be used to reset the manager
     */
    void dispose();
