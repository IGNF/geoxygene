...
/**
 * @author JeT
 *         User Interface associated with a primitive renderer.
 *         In Geoxygene it is integrated into the StyleEditionFrame
 */
public interface PrimitiveRendererUI {

    /**
     * get the associated primitive renderer
     */
    public PrimitiveRenderer getPrimitiveRenderer();

    /**
     * get the graphic interface
     */
