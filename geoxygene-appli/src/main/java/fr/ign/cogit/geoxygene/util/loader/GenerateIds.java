...
public class GenerateIds {
  ...
  // /////////////////////////////////////////////////////////////////////////////////////////////
  // /////////////////////////////////////////////////////////////////////////////////////////////
  // genere les identifiants dans la colonne COGITID, puis cree une cle primaire
  // sur cette colonne
  void genereIDOracle() {
    try {
      Connection conn = this.data.getConnection();
      ...
      while (rs.next()) {
        ...
        System.out.println(nbCount + " objets dans la table " + this.tableName
      ...
      proc = proc
          + " update " + this.tableName + " set cogitid=i where rowid=therowid;"; //$NON-NLS-1$ //$NON-NLS-2$
      ...
      stm.executeUpdate(update);
      System.out.println("cle primaire sur " + this.tableName
          + " ajoutee (colonne COGITID)");
  ...
  void genereIDPostgres() {
    try {
      ...
      // Si le maxID vaut 0 (il n'y a pas encore d'identifiant dans la base), on
      // le force à 1
      if (this.maxID == 0) {
        this.maxID = 1;
      }
      // Affectation du maxID à la séquence
      // On a pas besoin de l'affecter à maxID+1 puisque l'on utilise toujours
      // nextval pour affecter les identifiants
  ...
  // /////////////////////////////////////////////////////////////////////////////////////////////
  // /////////////////////////////////////////////////////////////////////////////////////////////
  // recherche du COGITID maximum parmi les tables Géographiques (variable
  // globale maxID)
