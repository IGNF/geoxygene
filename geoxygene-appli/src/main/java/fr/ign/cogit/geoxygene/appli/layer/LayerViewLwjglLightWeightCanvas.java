...
public class LayerViewLwjglLightWeightCanvas extends GLJPanel implements
    ComponentListener, GLEventListener {
  ...
  private static Logger logger = Logger
      .getLogger(LayerViewLwjglLightWeightCanvas.class.getName());

  /** @throws LWJGLException */
  public LayerViewLwjglLightWeightCanvas(LayerViewGLPanel parentPanel)
      throws LWJGLException {
  ...
  protected void initGL() {
    ...
    glLoadIdentity();
    glOrtho(0, getWidth(), getHeight(), 0, -1000, 1000);
  ...
  protected void paintGL() {
    ...
    try {
      ...
      logger.error("Exception thrown in LwJGLLightweightCanvas::paint() : "
          + e.getMessage());
    }
  ...
  public void componentResized(ComponentEvent e) {
    ...
    try {
      ...
      logger.error("Error resizing the lightweight AWTGLCanvas : "
          + e1.getMessage());
      // e1.printStackTrace();
    }
  }
