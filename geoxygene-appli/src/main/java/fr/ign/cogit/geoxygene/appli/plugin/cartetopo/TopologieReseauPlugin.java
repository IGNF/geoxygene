...
public class TopologieReseauPlugin implements GeOxygeneApplicationPlugin, ActionListener {
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        // String filename = "D:\\Data\\Appariement\\Haiti\\tout\\osm_extraitglobal_p.shp";
        // String filename = "D:\\Data\\Appariement\\Haiti\\tout\\sertit_extraitglobal.shp";
        // String filename = "D:\\Data\\Appariement\\Haiti\\routes_extrait2\\osm_extrait2_p.shp";
        // String filename = "D:\\Data\\Appariement\\MesTests\\TestUnitaire\\DeuxRebroussementsConsecutifs.shp";
        ...
        DialogTopoStructurePanel dialogTopoStructurePanel = new DialogTopoStructurePanel(paramFilename, this);
        ...
        if (dialogTopoStructurePanel.getAction().equals("LAUNCH")) {
            ...
            List<String> fileList = paramDoingTopologicalStructure.paramDataset.getListNomFichiersPopArcs();
            ...
            Iterator<IFeatureCollection<? extends IFeature>> itPopArcs = populationsArcs.iterator();
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs bruts des réseaux = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_BRUTS, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds bruts des réseaux = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_BRUTS, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après instanciation de la topologie = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_IMPORT, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après instanciation de la topologie = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_IMPORT, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            if (paramDoingTopologicalStructure.doRenduPlanaire) {
                ...
                if (LOGGER.isEnabledFor(Level.INFO)) {
                    LOGGER.info("Making the graph planar and instantiation of node-edge topology");
                }
                reseau.rendPlanaire(paramDoingTopologicalStructure.tolerance);
                reseau.filtreDoublons(paramDoingTopologicalStructure.tolerance);
            } 
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après planaire = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_PLANAIRE, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après planaire = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_PLANAIRE, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après fusion des noeuds proches = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_NOEUDS_PROCHES, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après fusion des noeuds proches = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_NOEUDS_PROCHES, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après fusion des noeuds proches = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_NOEUDS_ISOLES, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après fusion des noeuds proches = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_NOEUDS_ISOLES, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après fusion des noeuds proches = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_FILTRE_ARCS_INCIDENTS, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après fusion des noeuds proches = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_FILTRE_ARCS_INCIDENTS, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            LOGGER.info("==================================");
            LOGGER.info("Nombre d'arcs après fusion des noeuds proches = " + reseau.getPopArcs().size());
            resultStatArc.addNbElementForType(ResultCarteTopoStatElementInterface.NB_INDEXATION, reseau.getPopArcs().size());
            LOGGER.info("Nombre de noeuds après fusion des noeuds proches = " + reseau.getPopNoeuds().size());
            resultStatNoeud.addNbElementForType(ResultCarteTopoStatElementInterface.NB_INDEXATION, reseau.getPopNoeuds().size());
            LOGGER.info("==================================");
            ...
            // ShapefileWriter.write(reseau.getPopArcs(), "D:\\Data\\Appariement\\Haiti\\nettoyage\\ArcsToutSertit.shp");
