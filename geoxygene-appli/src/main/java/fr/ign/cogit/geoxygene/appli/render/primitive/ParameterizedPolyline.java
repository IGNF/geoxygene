...
/**
 * This class represents a polyline composed of 2D points and each point is associated with a parameter
 * The default parameter is the distance to the line start
 * The order of insertion is kept. Parameter values are not necessarily in asc/desc order...
 * @author JeT
 *
 */
public class ParameterizedPolyline implements DrawingPrimitive {
   ...
   * @param parameter parameter associated with the added point 
   */
  ...
  /**
   * Set a point value. The stored point instance stay the same, only it's content (x & y values) are modified
   * @param n point index to set point
   * @param p point values to set
   */
   ...
   * Set a point value. The stored point instance stay the same, only it's content (x & y values) are modified
   * @param n point index to set point
   * @param x x point value to set
   * @param y y point value to set
   */
  ...
  public String toString() {
    return "ParameterizedPolyline [points=" + this.points.size() + ", parameters=" + this.parameters.size() + ", shape="
        + (this.shape == null ? "none" : this.shape.getClass().getSimpleName()) + "]";
  }
