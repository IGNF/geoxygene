...
public class NoExpressiveRenderingUI implements ExpressiveRenderingUI {
    ...
    private ExpressiveRenderingDescriptor strtex = null;

    /**
     * Constructor
     */
    public NoExpressiveRenderingUI(ExpressiveRenderingDescriptor descriptor,
            ProjectFrame projectFrame) {
        this.parentProjectFrame = projectFrame;
        this.strtex = descriptor;
    }
    ...
    public JComponent getGui() {
        if (this.main == null) {
            ...
            this.main.add(new JLabel(
                    "No GUI defined for Expressive Rendering Descriptor type "
