...
public class GeOxygeneApplication {
    ...
    public GeOxygeneApplication(final String title,
        ...
        MainFrameMenuBar.fc.setRecents(GeOxygeneApplication.this.properties
                .getRecents());
        this.loadDefaultResourceDictionaries();
        ...
        AbstractGeometryEngine
                .setGeometrie(this.properties.getGeometryEngine());
        GeometryEngine.init();

        // Create the first project frame
        System.out.println("Create the default project frame");

        if (this.getMainFrame().getSelectedProjectFrame() == null) {
            if (this.properties.getDefaultVisualizationType().equals("AWT")) {
    ...
    private void preloadShapefiles() {
        ...
        // if (projectFrame == null) {
        try {
            System.out.println("preloadShapefiles");
    ...
    private void loadDefaultResourceDictionaries() {
        for (URL dic_path : this.properties.getResourceDictionaries()) {
            ResourceDictionary dic = ResourceDictionary.unmarshall(new File(
                    dic_path.getFile()));
            ResourcesManager.Root().loadDictionary(dic, false);
        }
    }
