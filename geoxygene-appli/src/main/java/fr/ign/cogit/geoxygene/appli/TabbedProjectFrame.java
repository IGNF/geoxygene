 ...
 */
public class TabbedProjectFrame extends AbstractProjectFrame implements
    ActionListener {
   ...
   */
  public TabbedProjectFrame(final TabbedMainFrame frame,
  ...
  public JPanel getPanel() {
    if (this.internalPanel == null) {
      ...
      this.internalPanel.setSize(TabbedProjectFrame.DEFAULT_WIDTH,
          TabbedProjectFrame.DEFAULT_HEIGHT);
