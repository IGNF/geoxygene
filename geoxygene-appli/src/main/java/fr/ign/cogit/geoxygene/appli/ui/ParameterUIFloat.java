 ...
 * 
 */
public class ParameterUIFloat extends AbstractParameterUI {

    private double value;
    private ParameterDescriptorFloat descriptor = null;
    private JPanel main;

    /**
     * @param descriptor
     */
    public ParameterUIFloat(ParameterDescriptorFloat descriptor) {
        super();
        ...
        if (this.main == null) {
            ...
            spinner.addChangeListener(new ChangeListener() {
                ...
                public void stateChanged(ChangeEvent e) {
                    ParameterUIFloat.this.value = (spinner.getValue());
                    ParameterUIFloat.this.refresh();
                }
            });
    ...
    public void setValuesToObject() {
        this.getDescriptor().setValue((float) this.value);
     ...
     */
    @Override
    public ParameterDescriptorFloat getDescriptor() {
