...
public class LinePaintingGLCanvas extends AWTGLCanvas implements MouseListener,
    ...
    public void setViewport(IEnvelope envelope) {
        ...
        this.transform.translate(envelope.getLowerCorner().getX(), envelope
                .getLowerCorner().getY());
        this.transform.scale(envelope.width() / this.getWidth(),
                envelope.length() / this.getHeight());
        ...
        for (ILineString line : lines) {
            try {
                LinePaintingTesselator.tesselateThickLine(complex,
                        line.getControlPoint(), new LinearFunction(10, 0), 10,
                        minX, minY);
    ...
    protected void paintGL() {
        ...
        try {
            ...
            System.err.println("screen = " + screenWidth + " " + screenHeight);
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        System.err.println("mouse = " + e.getX() + "x" + e.getY() + " => "
                + worldPosition.getX() + "x" + worldPosition.getY());
