...
public class Object2dNoLight extends BasicRep3D {
   ...
   *          surfacique (true)
   */
  public Object2dNoLight(IFeature feat, boolean isClrd, Color color,
    ...
    if (geometryInfo == null) {
      Object2dNoLight.logger.warn(Messages.getString("Representation.RepNulle"));
      return;
    }
    ...
    try {
      ...
      Object2dNoLight.logger.error(e.getMessage());
    }
   ...
   */
  public Object2dNoLight(IFeature feat, Color color) {
