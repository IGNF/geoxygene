package fr.ign.cogit.geoxygene.sig3d.representation.noLight;
 ...
 * @author MBrasebin
 */
public class Object3dNoLightEffect extends BasicRep3D {
  /**
   * le logger.
   */
  private static final Logger LOGGER = LogManager.getLogger(Object3dNoLightEffect.class
      .getName());
   ...
   */
  public Object3dNoLightEffect(IFeature feat) {
   ...
   */
  public Object3dNoLightEffect(IFeature feat, Color color) {
   ...
   *          surfacique (true)
   */
  public Object3dNoLightEffect(IFeature feat, boolean isClrd, Color color,
    ...
    if (geometryInfo == null) {
      Object3dNoLightEffect.LOGGER.warn(Messages.getString("Representation.RepNulle"));
      return;
    }
  ...
  private GeometryInfo geometryWithColor() {
    ...
    if (geom instanceof GM_Solid) {
      ...
      Object3dNoLightEffect.LOGGER.warn(Messages.getString("Representation.GeomUnk"));
      return null;
    }
