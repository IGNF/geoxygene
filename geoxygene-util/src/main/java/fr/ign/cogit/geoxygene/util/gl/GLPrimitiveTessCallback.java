...
public class GLPrimitiveTessCallback extends GLUtessellatorCallbackAdapter {
    ...
    private static final Logger logger = Logger.getLogger(GLPrimitiveTessCallback.class.getName()); // logger
    private GLComplex primitive = null;
     ...
     */
    public GLPrimitiveTessCallback(final GLComplex primitive) {
    ...
    public void combineData(final double[] coords, final Object[] data, final float[] weight, final Object[] outData, final Object polygonData) {
        //        System.err.println("combineData " + coords[0] + "," + coords[1] + "," + coords[2]);
        throw new UnsupportedOperationException("TessCallback::combineData() is called. I thought it shouldn't...");
    }
