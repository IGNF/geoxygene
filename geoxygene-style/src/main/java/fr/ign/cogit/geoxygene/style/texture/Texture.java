...
public abstract class Texture {
  ...
  /**
   * @param xRepeat the xRepeat to set
   */
  ...
  /**
   * @param yRepeat the yRepeat to set
   */
  ...
  /**
   * invalidate the precomputed image texture and force recomputation. For async
   * generation this method should be overridden to stop potential in-progress
   * generation
   */
   ...
   * (carefully)
   * 
   * @param textureImage the Texture Image to set
   */
  ...
  /**
   * @param dimension texture dimension in world coordinates (0 if internally
  ...
  /**
   * @param textureDrawingMode the textureDrawingMode to set
   */
