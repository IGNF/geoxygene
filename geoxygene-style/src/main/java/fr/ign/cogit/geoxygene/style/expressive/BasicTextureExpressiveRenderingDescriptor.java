...
public class BasicTextureExpressiveRenderingDescriptor extends
  ...
  /**
   * @param transitionSize the transitionSize to set
   */
   ...
   */
  public void setShader(ShaderDescriptor shader) {
    this.shader = shader;
  }
  ...
  /**
   * @param paperTextureFilename the paperTextureFilename to set
   */
  ...
  /**
   * @param brushTextureFilename the brushTextureFilename to set
   */
  ...
  /**
   * @param brushStartLength the brushStartLength to set
   */
  ...
  /**
   * @param brushEndLength the brushEndLength to set
   */
  ...
  /**
   * @param paperSizeInCm the paperScaleFactor to set
   */
  ...
  /**
   * @param paperReferenceMapScale the paperReferenceMapScale to set
   */
  ...
  /**
   * @param paperDensity the paperDensity to set
   */
  ...
  /**
   * @param brushDensity the brushDensity to set
   */
  ...
  /**
   * @param strokePressure the strokePressure to set
   */
  ...
  public int hashCode() {
    ...
    result = prime
        * result
        + ((this.brushTextureFilename == null) ? 0 : this.brushTextureFilename
            .hashCode());
    result = prime
        * result
        + ((this.paperTextureFilename == null) ? 0 : this.paperTextureFilename
            .hashCode());
    result = prime * result
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!this.brushTextureFilename.equals(other.brushTextureFilename)) {
      return false;
    }
    ...
    } else if (!this.paperTextureFilename.equals(other.paperTextureFilename)) {
      return false;
    }
    if (this.shader == null) {
