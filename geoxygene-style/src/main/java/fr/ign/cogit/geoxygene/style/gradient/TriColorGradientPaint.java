...
public class TriColorGradientPaint implements Paint {
  ...
  public TriColorGradientPaint(Point2D pt1, Color color1, Point2D pt2,
      Color color2, Point2D pt3, Color color3) {
    if ((color1 == null) || (color2 == null) || (pt1 == null) || (pt2 == null)) {
      throw new NullPointerException("Colors and points should be non-null"); //$NON-NLS-1$
    }
  ...
  public PaintContext createContext(ColorModel cm, Rectangle deviceBounds,
    ...
    return new TriColorGradientPaintContext(cm, this.p1, this.p2, this.p3,
        xform, this.color1, this.color2, this.color3);
  }
  ...
  public int getTransparency() {
    ...
    return (((a1 & a2 & a3) == 0xff) ? Transparency.OPAQUE
