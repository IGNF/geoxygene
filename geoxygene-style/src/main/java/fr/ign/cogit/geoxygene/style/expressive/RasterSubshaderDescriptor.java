...
/**
 * @author amasse
 * To be cleaned, with a huge sweep
 */
@XmlAccessorType(XmlAccessType.NONE)
public class RasterSubshaderDescriptor extends Fill2DDescriptor {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RasterSubshaderDescriptor other = (RasterSubshaderDescriptor) obj;
    ...
    public String toString() {
        return "RasterSubshaderDescriptor [shader=" + shader
