...
/**
 * @author JeT
 * GUIcomponent able to edit scripts
 */
public interface ScriptingConsoleUI {
  ...
  //  boolean setScriptText(String text);

  String getScriptText();

  //  boolean setScriptText(String id, String text);

  String getScriptText(String id);
