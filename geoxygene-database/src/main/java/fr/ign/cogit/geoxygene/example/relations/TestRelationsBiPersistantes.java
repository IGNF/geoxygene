...
/**
 * Test des relations BIDIRECTIONNELLES entre les classes AAA et BBB. Ce test
 * teste aussi la persistance. C'est le meme que
 * "TestRelationsBiNonPersistantes", avec en plus les fonctions d'ecriture dans
 * le SGBD. On peut controler a tout moment l'etat de la base en activant des
 * commit et en quittant l'application. Pensez a activer le fichier de mapping
 * "repository_AAA_BBB.xml" . La base s'initialise avec le script
...
public class TestRelationsBiPersistantes {
  ...
  static Geodatabase db = GeodatabaseOjbFactory.newInstance();

  public static void main(String args[]) {
    System.out.println("DEBUT DES TESTS");
    TestRelationsBiPersistantes.test_bi11();
    TestRelationsBiPersistantes.test_bi1n();
    TestRelationsBiPersistantes.test_binn();
    TestRelationsBiPersistantes.charge();
  }

  /** Teste la relation 1-1 bi-directionnelle */
  public static void test_bi11() {

    TestRelationsBiPersistantes.db.begin();
    ...
    TestRelationsBiPersistantes.db.makePersistent(a1);
    TestRelationsBiPersistantes.db.makePersistent(a2);
    TestRelationsBiPersistantes.db.makePersistent(a3);
    TestRelationsBiPersistantes.db.makePersistent(b1);
    TestRelationsBiPersistantes.db.makePersistent(b2);
    TestRelationsBiPersistantes.db.makePersistent(b3);
    ...
    System.out.println("objet BBB en relation avec a2 (null) : "
        + a2.getObjetBBB_bi11());
    System.out.println("objet AAA en relation avec b1 (null) : "
        + b1.getObjetAAA_bi11());
    System.out.println("objet AAA en relation avec b2 (null) : "
        + b2.getObjetAAA_bi11());
    System.out.println("--");
    ...
    System.out.println("objet BBB en relation avec a1 (b1) : "
        + a1.getObjetBBB_bi11().getNom());
    System.out.println("objet BBB en relation avec a2 (null) : "
        + a2.getObjetBBB_bi11());
    System.out.println("objet AAA en relation avec b1 (a1) : "
        + b1.getObjetAAA_bi11().getNom());
    System.out.println("objet AAA en relation avec b2 (null) : "
        + b2.getObjetAAA_bi11());
    ...
    System.out.println("objet AAA en relation avec b1 (null) : "
        + b1.getObjetAAA_bi11());
    System.out.println("objet AAA en relation avec b2 (a1) : "
        + b2.getObjetAAA_bi11().getNom());
    /* decommenter si on veut consulter l'etat de la base ici */
    // db.commit();
    // System.exit(0);
    ...
    System.out.println("objet BBB en relation avec a2 (b2) : "
        + a2.getObjetBBB_bi11().getNom());
    System.out.println("objet AAA en relation avec b1 (null) : "
        + b1.getObjetAAA_bi11());
    System.out.println("objet AAA en relation avec b2 (a2) : "
        + b2.getObjetAAA_bi11().getNom());
    /* decommenter si on veut consulter l'etat de la base ici */
    // db.commit();
    // System.exit(0);
    ...
    System.out.println("objet BBB en relation avec a1 (null) : "
        + a1.getObjetBBB_bi11());
    System.out.println("objet BBB en relation avec a2 (b1) : "
        + a2.getObjetBBB_bi11().getNom());
    System.out.println("objet AAA en relation avec b1 (a2) : "
        + b1.getObjetAAA_bi11().getNom());
    System.out.println("objet AAA en relation avec b2 (null) : "
        + b2.getObjetAAA_bi11());
    /* decommenter si on veut consulter l'etat de la base ici */
     ...
     */
    /* decommenter si on veut consulter l'etat de la base ici */
    TestRelationsBiPersistantes.db.commit();
  ...
  public static void test_bi1n() {
    ...
    TestRelationsBiPersistantes.affiche(a1.getListe_objetsBBB_bi1N());
    System.out.println("objet BBB en relation avec a2 (vide) : ");
    TestRelationsBiPersistantes.affiche(a2.getListe_objetsBBB_bi1N());
    System.out.println("objet BBB en relation avec a3 (vide) : ");
    TestRelationsBiPersistantes.affiche(a3.getListe_objetsBBB_bi1N());
    System.out.println("objet AAA en relation avec b1 (null) : "
        + b1.getObjetAAA_bi1N());
    System.out.println("objet AAA en relation avec b2 (null) : "
        + b2.getObjetAAA_bi1N());
    System.out.println("objet AAA en relation avec b3 (null) : "
        + b3.getObjetAAA_bi1N());
    /* decommenter si on veut consulter l'etat de la base ici */
    // db.commit();
    // System.exit(0);
    ...
    TestRelationsBiPersistantes.affiche(a3.getListe_objetsBBB_bi1N());
    System.out.println("objet AAA en relation avec b1 (a1) : "
        + b1.getObjetAAA_bi1N().getNom());
    System.out.println("objet AAA en relation avec b2 (a2) : "
        + b2.getObjetAAA_bi1N().getNom());
    System.out.println("objet AAA en relation avec b3 (a2) : "
        + b3.getObjetAAA_bi1N().getNom());
    /* decommenter si on veut consulter l'etat de la base ici */
    // db.commit();
    // System.exit(0);
  ...
  public static void test_binn() {
    ...
    System.out.println("objet BBB en relation avec a1 (b1, b2) : ");
    TestRelationsBiPersistantes.affiche(a1.getListe_objetsBBB_biNM());
    System.out.println("objet BBB en relation avec a2 (b2) : ");
    TestRelationsBiPersistantes.affiche(a2.getListe_objetsBBB_biNM());
    System.out.println("objet BBB en relation avec a3 (b3) : ");
    TestRelationsBiPersistantes.affiche(a3.getListe_objetsBBB_biNM());
    System.out.println("objet AAA en relation avec b1 (a1) : ");
    TestRelationsBiPersistantes.affiche(b1.getListe_objetsAAA_biNM());
    System.out.println("objet AAA en relation avec b2 (a1, a2) : ");
    TestRelationsBiPersistantes.affiche(b2.getListe_objetsAAA_biNM());
    System.out.println("objet AAA en relation avec b3 (a3) : ");
    TestRelationsBiPersistantes.affiche(b3.getListe_objetsAAA_biNM());
    /* decommenter si on veut consulter l'etat de la base ici */
    // db.commit();
    // System.exit(0);
  ...
  public static void charge() {
    TestRelationsBiPersistantes.db.begin();
    List<?> allBBB = TestRelationsBiPersistantes.db.loadAll(BBB.class);
    List<?> allAAA = TestRelationsBiPersistantes.db.loadAll(AAA.class);
    ...
    while (itA.hasNext()) {
      ...
      if (a.getObjetBBB_bi11() != null) {
        System.out.print("id = " + a.getObjetBBB_bi11().getId() + " - nom = "
            + a.getObjetBBB_bi11().getNom());
      }
      System.out.println();
      System.out.println("        lien 1-n : ");
      TestRelationsBiPersistantes.affiche(a.getListe_objetsBBB_bi1N());
      System.out.println("        lien n-m : ");
      TestRelationsBiPersistantes.affiche(a.getListe_objetsBBB_biNM());
    }
    System.out.println();
    ...
    while (itB.hasNext()) {
      BBB b = (BBB) itB.next();
      System.out.println("##  objet - id = " + b.getId() + " - nom = "
          + b.getNom());
      System.out.print("        lien 1-1 : ");
      if (b.getObjetAAA_bi11() != null) {
        System.out.print("id = " + b.getObjetAAA_bi11().getId() + " - nom = "
            + b.getObjetAAA_bi11().getNom());
      }
      System.out.println();
      System.out.print("        lien 1-n : ");
      if (b.getObjetAAA_bi1N() != null) {
        System.out.print("id = " + b.getObjetAAA_bi1N().getId() + " - nom = "
            + b.getObjetAAA_bi1N().getNom());
      }
      System.out.println();
      System.out.println("        lien n-m : ");
      TestRelationsBiPersistantes.affiche(b.getListe_objetsAAA_biNM());
    }
  }
