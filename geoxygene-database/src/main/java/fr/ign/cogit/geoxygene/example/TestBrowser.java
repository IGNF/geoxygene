 ...
 * (ObjectBrowser), permettant de montrer comment on appelle celui-ci afin de
 * visualiser graphiquement l'état d'un objet Java.
 * 
...
public class TestBrowser {
  ...
  public TestBrowserObjTest Attribut10 = new TestBrowserObjTest(
      "Youpla boum !!!", 34);
  ...
  // protected StringBuffer Attribut19=new
  // StringBuffer("test of a StringBuffer class");
  ...
  public static void main(String args[]) {
    ...
    TestBrowserObjTest vobjelt = new TestBrowserObjTest("Yiiiiiiiiipi !!! :))",
        58);
    ...
    /*
     * Vector v20=new Vector(); v20.add("?"); v20.add("??"); v20.add("???");
     * obj.Attribut20.add(v20); obj.Attribut20.add(v20);
     */
