 ...
 * ne teste que le fonctionnement en Java, sans tester la persistance. Essayer
 * aussi le test "TestRelationsMonoPersistantes" : c'est le meme, avec les
...
public class TestRelationsMonoNonPersistantes {
  ...
  public static void main(String args[]) {
    ...
    TestRelationsMonoNonPersistantes.test_mono11();
    TestRelationsMonoNonPersistantes.test_mono1N();
    TestRelationsMonoNonPersistantes.test_monoNN();
  }
  ...
  public static void test_mono1N() {
    ...
    TestRelationsMonoNonPersistantes.affiche(a1.getListe_objetsBBB_mono1N());
    System.out.println("objet BBB en relation avec a2 (vide) : ");
    TestRelationsMonoNonPersistantes.affiche(a2.getListe_objetsBBB_mono1N());
    System.out.println("objet BBB en relation avec a3 (vide) : ");
    TestRelationsMonoNonPersistantes.affiche(a3.getListe_objetsBBB_mono1N());
  ...
  public static void test_monoNN() {
    ...
    TestRelationsMonoNonPersistantes.affiche(a1.getListe_objetsBBB_monoNM());
    System.out.println("objet BBB en relation avec a2 (b2) : ");
    TestRelationsMonoNonPersistantes.affiche(a2.getListe_objetsBBB_monoNM());
    System.out.println("objet BBB en relation avec a3 (b3) : ");
    TestRelationsMonoNonPersistantes.affiche(a3.getListe_objetsBBB_monoNM());
