...
INSERT INTO USER_SDO_GEOM_METADATA VALUES ('RESULTAT',
					'GEOM',
					MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X', -180, 180, 5.0000E-10), 
							MDSYS.SDO_DIM_ELEMENT('Y',-90, 90, 5.0000E-10)),
					NULL);
