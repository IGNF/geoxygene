 ...
 */
@Entity
public class AgentEspaceVide extends AgentGeographique {

	/**
	 * 
	 */
	public AgentEspaceVide() {
		super();
		this.representationClass=EspaceVide.class;
	 ...
	 * @param idGeo
	 */
	public AgentEspaceVide(int idGeo) {super(idGeo, EspaceVide.class);}
