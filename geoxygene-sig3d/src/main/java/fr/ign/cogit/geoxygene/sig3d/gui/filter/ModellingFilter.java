 ...
 * 
 * 
 *         Cette classe permet de ne sélectionner que des fichiers obj ou 3DS
 * 
 *         This class enables to select only obj or 3DS
 * 
 */
import java.io.File;
...
public class ModellingFilter extends FileFilter {
  ...
  public boolean accept(File fichier) {
    ...
    if (extension != null) {
      ...
      if ("3ds".equalsIgnoreCase(extension)) {
        return true;
  ...
  public String getDescription() {
    return "Modelling files (.obj) ou (.3ds)";
  }
