 ...
 * 
 */
public class VectorLayer extends FT_FeatureCollection<IFeature> implements
    Layer {
   ...
   * 
   * @param featColl les entités de la couche
   * @param layerName le nom de la couche
   */
  public VectorLayer(IFeatureCollection<? extends IFeature> featColl,
      String layerName) {
    this();
   ...
   * entités
   * 
   * @param featColl Les entites que l'on souhaite integrer dans la couche
   * @param layerName Le nom que portera la couche
   * @param isClrd Indique si la couche aura une couleur (sinon representation
   *          multi-coloree)
   * @param color Couleur a appliquer sur la couche
   * @param coefOpacity Coefficient d'opacite (entre 0 et 1)
   * @param isSolid Representation solide ou nom de la couche
   */
  public VectorLayer(IFeatureCollection<? extends IFeature> featColl,
      String layerName, boolean isClrd, Color color, double coefOpacity,
      boolean isSolid) {
    this();
    this.visible = true;
    this.selectable = true;
    ...
    for (int i = 0; i < nbElement; i++) {
      ...
      switch (dimension) {
        ...
        case 0:
          representation = new Object0d(obj, isClrd, color, coefOpacity,
              isSolid);
          break;
        case 1:
          representation = new Object1d(obj, isClrd, color, coefOpacity,
              isSolid);
          break;

        case 2:
          representation = new Object2d(obj, isClrd, color, coefOpacity,
              isSolid);
          break;

        case 3:

          representation = new Object3d(obj, isClrd, color, coefOpacity,
              isSolid);
          break;
        default:
   ...
   * 
   * @param hasColor indique si l'on a une couleur fixe ou aléatoire
   * @param couleur la couleur à appliquer (argument non utilisé si hasColor =
   *          false)
   * @param opacite le coefficient d'opacité entre 0 et 1 (0 invisible)
   * @param isSolid indique si l'objet est solide (par rapport à filaire)
   */
  public void updateStyle(boolean hasColor, Color couleur, double opacite,
      boolean isSolid) {
    ...
    for (int i = 0; i < nbElement; i++) {
      ...
      switch (dimension) {
        ...
        case 0:
          representation = new Object0d(obj, hasColor, couleur, opacite,
              isSolid);
          break;
        case 1:
          representation = new Object1d(obj, hasColor, couleur, opacite,
              isSolid);
          break;

        case 2:
          representation = new Object2d(obj, hasColor, couleur, opacite,
              isSolid);
          break;

        case 3:

          representation = new Object3d(obj, hasColor, couleur, opacite,
              isSolid);
          break;
        default:
          // TODO: Implement 'default' statement
