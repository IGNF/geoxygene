...
public class CG_X3DMaterial extends CG_AbstractSurfaceData {
  ...
  public CG_X3DMaterial(X3DMaterial sD) {
    ...
    if (sD.isSetDiffuseColor()) {
      this.diffuseColor = new Color3f(sD.getDiffuseColor().getRed()
          .floatValue(), sD.getDiffuseColor().getGreen().floatValue(), sD
          .getDiffuseColor().getGreen().floatValue());
    }

    if (sD.isSetEmissiveColor()) {
      this.emissiveColor = new Color3f(sD.getEmissiveColor().getRed()
          .floatValue(), sD.getDiffuseColor().getGreen().floatValue(), sD
          .getDiffuseColor().getGreen().floatValue());
    }

    if (sD.isSetSpecularColor()) {
      this.specularColor = new Color3f(sD.getSpecularColor().getRed()
          .floatValue(), sD.getDiffuseColor().getGreen().floatValue(), sD
          .getDiffuseColor().getGreen().floatValue());
    }
   ...
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the emissiveColor property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the specularColor property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
