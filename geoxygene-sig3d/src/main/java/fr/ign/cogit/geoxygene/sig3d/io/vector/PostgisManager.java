...
public class PostgisManager {
   ...
   * @throws Exception
   */
  public static IFeatureCollection<IFeature> loadGeometricTableWhereClause(
      ...
      while (r1.next()) {
        ...
        if (nomField.equals(nomColonneGeom)) {
          ...
          String valueType = PostgisManager.fromSQLTypeToJava(r2.getMetaData()
              .getColumnType(compt + shiftIni)); // on
                                                 // invite
                                                 // le
                                                 // asewkt,
          // les indexes
   ...
   * @param pw mot de passe
   * @param table le nom de la table que l'on souhaite charger
   * @param adapteListToAttribute si true permet de regénérer la liste des
   *          attributs stockés pour chaque entité
   * @return les entités de la table avec les attributs renseignés. Null renvoyé
   *         pour table non-géométriques
   */
   ...
   * @return les entités de la table avec les attributs renseignés.
   */
  public static boolean insertInNonGeometricTable(String host, String port,
      String database, String user, String pw, String table,
      IFeatureCollection<? extends IFeature> featColl) throws Exception {
  ...
  public static boolean saveGeometricTable(String host, String port,
      String database, String user, String pw, String table,
      IFeatureCollection<? extends IFeature> featColl, boolean erase)
      throws Exception {
