...
*/
    static public void assertEquals(String message, Object expected,
        ...
        if (equalsRegardingNull(expected, actual)) {
        	...
        	System.out.println("Cas String");
            String cleanMessage = message == null ? "" : message;
            throw new ComparisonFailure(cleanMessage, (String) expected,
                    (String) actual);
        } else if (expected instanceof GM_Polygon && actual instanceof GM_Polygon) {
        	System.out.println("Cas GM_Polygon");
        	return;
        } else if (expected instanceof GM_LineString && actual instanceof GM_LineString) {
            	System.out.println("Cas GM_LineString");
            	return;
        } else {
        	System.out.println("");
