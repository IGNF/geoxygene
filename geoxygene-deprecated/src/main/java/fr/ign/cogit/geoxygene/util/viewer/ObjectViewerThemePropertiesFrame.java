...
/**
 * This class implements the frame for the defintion of properties of themes to
 * be displayed in the (Geo)Object viewer.
 * 
...
class ObjectViewerThemePropertiesFrame extends JFrame {
  ...
  public static final String FRAME_TITLE = "GeOxygene Object Viewer - Theme Properties";

  private ObjectViewerThemeProperties objectViewerThemeProperties;

  public ObjectViewerThemePropertiesFrame(
      ObjectViewerThemeProperties objectViewerThemeProperties) {

    super(ObjectViewerThemePropertiesFrame.FRAME_TITLE);
    ...
    themePropertiesPanel.setBorder(BorderFactory
        .createTitledBorder("Theme Properties"));

    JPanel themeShadersPanel = new JPanel(new GridLayout(3, 2, 1, 50));
    themeShadersPanel.setBorder(BorderFactory
        .createTitledBorder("Shader Properties"));

    // Add the components to the themePropertiesPanel
    JLabel fillThemeColorLabel = new JLabel("Fill in Theme Color:");
    Icon fillThemeColorButtonIcon = new RectIcon(this
    ...
    Icon outlineThemeColorButtonIcon = new RectIcon(this
    ...
    Icon fillHighlightColorButtonIcon = new RectIcon(
    ...
    JLabel outlineHighlightColorLabel = new JLabel("Outline Highlight Color:");
    Icon outlineHighlightColorButtonIcon = new RectIcon(this
    ...
    Icon fillSelectionColorButtonIcon = new RectIcon(this
    ...
    JLabel outlineSelectionColorLabel = new JLabel("Outline Selection Color:");
    Icon outlineSelectionColorButtonIcon = new RectIcon(this
    ...
    if (this.getObjectViewerThemeProperties().getDataSourceType() == Utils.GEOXYGENE) {

      JLabel shaderLabel = new JLabel("Type of shader:");
      shaderTypeComboBox = new JComboBox(new String[] { "Mono", "Random",
          "Continuous", "Unique" });
      shaderTypeComboBox.setSelectedItem(this.getShaderName(this
          .getObjectViewerThemeProperties().getShader()));
      final JLabel attributeDoubleLabel = new JLabel(
          "Attributes (double or int):");
      ...
      String[] doubleFieldsNames = this.getDoubleOrIntFields();
      if (doubleFieldsNames.length > 0) {
        for (String doubleFieldsName : doubleFieldsNames) {
          attributeDoubleComboBox.addItem(doubleFieldsName);
        }
        if (this.getObjectViewerThemeProperties().getShadedBy() != null
            && this.getSelectedFieldClass(
                this.getObjectViewerThemeProperties().getShadedBy()).equals(
                double.class)) {
          attributeDoubleComboBox.setSelectedItem(this
              .getObjectViewerThemeProperties().getShadedBy());
        } else {
          attributeDoubleComboBox.setSelectedItem(doubleFieldsNames[0]);
        }
      }

      String[] stringFieldsNames = this.getStringFields();
      if (stringFieldsNames.length > 0) {
        for (String stringFieldsName : stringFieldsNames) {
          attributeStringComboBox.addItem(stringFieldsName);
        }
        if (this.getObjectViewerThemeProperties().getShadedBy() != null
            && this.getSelectedFieldClass(
                this.getObjectViewerThemeProperties().getShadedBy()).equals(
                String.class)) {
          attributeStringComboBox.setSelectedItem(this
              .getObjectViewerThemeProperties().getShadedBy());
        } else {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        ObjectViewerThemePropertiesFrame.this.getObjectViewerThemeProperties()
            .setFillInThemeColor(
                ((RectIcon) (fillThemeColorButton.getIcon())).getColor());
        ObjectViewerThemePropertiesFrame.this.getObjectViewerThemeProperties()
            .setOutlineThemeColor(
                ((RectIcon) (outlineThemeColorButton.getIcon())).getColor());
        ObjectViewerThemePropertiesFrame.this.getObjectViewerThemeProperties()
            .setFillInHighlightColor(
                ((RectIcon) (fillHighlightColorButton.getIcon())).getColor());
        ObjectViewerThemePropertiesFrame.this
            .getObjectViewerThemeProperties()
            .setOutlineHighlightColor(
                ((RectIcon) (outlineHighlightColorButton.getIcon())).getColor());
        ObjectViewerThemePropertiesFrame.this.getObjectViewerThemeProperties()
            .setFillInSelectionColor(
                ((RectIcon) (fillSelectionColorButton.getIcon())).getColor());
        ObjectViewerThemePropertiesFrame.this
            .getObjectViewerThemeProperties()
            .setOutlineSelectionColor(
                ((RectIcon) (outlineSelectionColorButton.getIcon())).getColor());
        if ((ObjectViewerThemePropertiesFrame.this
            .getObjectViewerThemeProperties().getDataSourceType() == Utils.GEOXYGENE)
            && (attributeDoubleComboBox != null)
            && (attributeStringComboBox != null)
            && (shaderTypeComboBox != null)) {
          if (attributeDoubleComboBox.isEnabled()
              && !attributeStringComboBox.isEnabled()) {
            ObjectViewerThemePropertiesFrame.this
                .getObjectViewerThemeProperties().setShader(
                    ObjectViewerThemePropertiesFrame.this
                        .selectShader((String) shaderTypeComboBox
                            .getSelectedItem()),
                    (String) attributeDoubleComboBox.getSelectedItem());
          } else if (!attributeDoubleComboBox.isEnabled()
              && attributeStringComboBox.isEnabled()) {
            ObjectViewerThemePropertiesFrame.this
                .getObjectViewerThemeProperties().setShader(
                    ObjectViewerThemePropertiesFrame.this
    ...
    themePropertiesTabbedPanel.setToolTipTextAt(0,
    ...
    themePropertiesTabbedPanel.setToolTipTextAt(1,
  ...
  private String getShaderName(Shader shader) {
    if (shader instanceof MonoShader) {
      ...
      return "### PROBLEM selecting shader name !!";
    }
  }
  ...
  private String[] getDoubleOrIntFields() {
    ...
    for (String allField : allFields) {
      if (this.getSelectedFieldClass(allField).equals(double.class)
          || this.getSelectedFieldClass(allField).equals(int.class)) {
        vector.add(allField);
      }
    }
  ...
  private String[] getStringFields() {
    ...
    String[] allFields = this.getFieldNames();
    for (String allField : allFields) {
      if (this.getSelectedFieldClass(allField).equals(String.class)) {
        vector.add(allField);
      }
    }
    String[] array = new String[vector.size()];
