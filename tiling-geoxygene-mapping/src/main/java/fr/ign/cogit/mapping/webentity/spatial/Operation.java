...
public abstract class Operation {
    ...
    public static class Helper {
        ...
        public static Operation invert(final Operation tester) {
            return new Operation() {
                ...
                @Override
                public IntersectionMatrix[] getIntersectionMatrices() {
                    IntersectionMatrix[] matrix = tester
    ...
    public static class Egenhofer {
        ...
        public static final Operation COVERS = new Operation() {
            ...
            @Override
            public IntersectionMatrix[] getIntersectionMatrices() {
                return Helper.create("T*****FF*", "*T****FF*", "***T**FF*",
                        "****T*FF*");
            }
        };

        // public static final Operation COVEREDBY = new
        // MatrixTester("TFF*TFT**");
        ...
        public static final Operation COVEREDBY = new Operation() {
            ...
            @Override
            public IntersectionMatrix[] getIntersectionMatrices() {
                return Helper.create("T*F**F***", "*TF**F***", "**FT*F***",
                        "**F*TF***");
            }
        };
    ...
    public static class RCC_EXT {
        ...
        public static final Operation PROPER_PART = new MatrixTester(
                (MatrixTester) RCC8.TPP, (MatrixTester) RCC8.NTPP);
        public static final Operation INV_PROPER_PART = new MatrixTester(
                (MatrixTester) RCC8.TPPI, (MatrixTester) RCC8.NTPPI);
    }
}
