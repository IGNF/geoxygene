...
public class MGCPCommunicationStation extends MGCPFeature implements
    IBoundedArea {
  ...
  private String ace, ale, cpyrt_note, hgt, len, nam, nfi, nfn, src_date,
      src_info, tier_note, txt, uid, upd_date, upd_info, voi;
  private long acc, ace_eval, ale_eval, fun, nst, smc, src_name, upd_name,
      zval_type;

  /**
   * @param type
   */
  public MGCPCommunicationStation(IPolygon polygon,
