...
public class SHOMSandGravelArea extends SHOMFeature implements ISimpleLandUseArea {

  // VMAP attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMSandGravelArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMSandGravelArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
