...
public class VMAP1PPRigwellP extends VMAP1PPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String date_bdi, f_code, gfid_v2i, nam, src_date, src_info, txt,
      uid_, upd_date, upd_info, v2i_f_code, valid_date, valid_info, prodct,
      status, catofp, natcon;
  private long exs, fcsubtype, hgt, keep, loc, obj_rmq, pro, src_dim, src_name,
      upd_name, valid_stat, zv2, originform, targetscal, scamax, scamin;

  /**
   * @param type
   */
  public VMAP1PPRigwellP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.catofp = (String) attributes.get("catofp");
  ...
  public String getCatofp() {
    return catofp;
  }

  public void setCatofp(String catofp) {
    this.catofp = catofp;
  }
