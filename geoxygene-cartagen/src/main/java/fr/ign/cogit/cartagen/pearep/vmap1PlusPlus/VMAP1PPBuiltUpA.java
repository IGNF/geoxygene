...
public class VMAP1PPBuiltUpA extends VMAPFeature implements ISimpleLandUseArea {
  ...
  private long exs, fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      use_, valid_stat, scamax, scamin, hgt, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPBuiltUpA(IPolygon polygon, HashMap<String, Object> attributes,
