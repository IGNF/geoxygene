...
public class VMAP1PPMisaeroP extends VMAP1PPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String date_bdi, f_code, gfid_v2i, hgt, src_date, src_info, txt,
      uid_, upd_date, upd_info, v2i_f_code, valid_date, valid_info;
  private long exs, fcsubtype, keep, lfa, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, zv2, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPMisaeroP(IPoint point, HashMap<String, Object> attributes,
