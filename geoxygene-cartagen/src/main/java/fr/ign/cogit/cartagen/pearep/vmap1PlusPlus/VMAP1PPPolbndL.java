...
public class VMAP1PPPolbndL extends VMAP1PPFeature implements IAdminLimit {
  ...
  private long acc, bst, fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      use_, valid_stat;
