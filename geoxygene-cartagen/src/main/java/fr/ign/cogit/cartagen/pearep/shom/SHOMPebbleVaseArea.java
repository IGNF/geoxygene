...
public class SHOMPebbleVaseArea extends SHOMFeature implements ISimpleLandUseArea {

  // VMAP attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMPebbleVaseArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMPebbleVaseArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
