...
public class VMAP1PPStorageP extends VMAP1PPFeature implements IBuildPoint {
  ...
  private long exs, fcsubtype, hgt, keep, loc, obj_rmq, pro, src_dim, src_name,
      ssc, wid, zv2, upd_name, valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPStorageP(IPoint point, HashMap<String, Object> attributes,
