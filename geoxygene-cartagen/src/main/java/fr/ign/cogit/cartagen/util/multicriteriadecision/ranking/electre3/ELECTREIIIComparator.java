...
public class ELECTREIIIComparator implements Comparator<ELECTREIIIAction> {
  ...
  public int compare(ELECTREIIIAction arg0, ELECTREIIIAction arg1) {
    if(preOrderZ1.outranks(arg0,arg1)&&preOrderZ2.outranks(arg0,arg1)) 
      return Math.round((preOrderZ1.difference(arg0,arg1)+preOrderZ2.difference(arg0,arg1))/2);
    if(preOrderZ1.outranks(arg1,arg0)&&preOrderZ2.outranks(arg1,arg0)) 
      return Math.round((preOrderZ1.difference(arg1,arg0)+preOrderZ2.difference(arg1,arg0))/2);
    return 0;
  }
