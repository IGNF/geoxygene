...
public class VMAP1PPPowerL extends VMAP1PPFeature implements IElectricityLine {
  ...
  private long acc, fcsubtype, keep, obj_rmq, ppc, src_dim, src_name, tst,
      upd_name, valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPPowerL(ILineString lineString,
