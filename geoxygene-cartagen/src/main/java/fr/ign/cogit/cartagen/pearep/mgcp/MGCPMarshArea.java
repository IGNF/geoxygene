...
public class MGCPMarshArea extends MGCPFeature implements ISimpleLandUseArea {
  ...
  private long acc, ace_eval, ale_eval, fcsubtype, smc, src_name, upd_name,
      tid, valid_stat, wle, zval_type, originform, targetscal;
  private double area;

  public MGCPMarshArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public MGCPMarshArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
