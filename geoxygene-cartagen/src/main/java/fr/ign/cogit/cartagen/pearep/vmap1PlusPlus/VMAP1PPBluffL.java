...
public class VMAP1PPBluffL extends VMAP1PPFeature implements IReliefElementLine {
  ...
  private long fcsubtype, hgt, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPBluffL(ILineString lineString,
