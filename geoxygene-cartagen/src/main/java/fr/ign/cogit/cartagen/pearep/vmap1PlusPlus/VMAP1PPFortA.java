...
public class VMAP1PPFortA extends VMAP1PPFeature implements IBuildArea {
   ...
   * @param type
   */
  public VMAP1PPFortA(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.src_info = getStringAttribute("src_info");
    this.catfor = getStringAttribute("catfor");
