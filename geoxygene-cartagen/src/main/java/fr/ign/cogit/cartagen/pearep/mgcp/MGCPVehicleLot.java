...
public class MGCPVehicleLot extends MGCPFeature implements IBoundedArea {
  ...
  private String ace, ale, cpyrt_note, src_date, src_info, tier_note, txt, uid,
      upd_date, upd_info;
  private long acc, ace_eval, ale_eval, rst, src_name, upd_name, zval_type;

  /**
   * @param type
   */
  public MGCPVehicleLot(IPolygon polygon, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
