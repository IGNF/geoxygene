...
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.swingcomponents.renderer.RangeSliderUI;
...
public class RangeSlider extends JSlider {
  ...
  public void setValue(int value) {
    ...
    int newValue = Math
        .min(Math.max(getMinimum(), value), oldValue + oldExtent);
