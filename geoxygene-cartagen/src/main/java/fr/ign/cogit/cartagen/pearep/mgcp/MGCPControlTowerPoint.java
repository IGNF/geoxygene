...
public class MGCPControlTowerPoint extends MGCPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, hgt, nam, nfi, nfn, src_date, src_info,
      tier_note, txt, uid, upd_date, upd_info, wid, voi;
  private long acc, ace_eval, ale_eval, awp, fun, src_name, smc, ttc, upd_name,
      zval_type;

  /**
   * @param type
   */
  public MGCPControlTowerPoint(IPoint point,
