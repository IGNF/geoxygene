...
public class VMAP1PPWellsprP extends VMAP1PPFeature implements IMiscPoint {
  ...
  private long exs, fcsubtype, hyc, keep, obj_rmq, pro, scc, src_dim, src_name,
      upd_name, valid_stat, wft, originform, targetscal, scamax, scamin;

  /**
   * @param type
   */
  public VMAP1PPWellsprP(IPoint point, HashMap<String, Object> attributes,
