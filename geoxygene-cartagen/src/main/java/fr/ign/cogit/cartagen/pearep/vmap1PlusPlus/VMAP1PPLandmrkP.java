...
public class VMAP1PPLandmrkP extends VMAP1PPFeature implements IMiscPoint {
  ...
  private long exs, fcsubtype, hgt, keep, obj_rmq, src_dim, src_name, ssc,
      upd_name, valid_stat, zv2, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPLandmrkP(IPoint point, HashMap<String, Object> attributes,
