...
public class VMAP1PPOrchardA extends VMAPFeature implements ISimpleLandUseArea {
   ...
   * @param type
   */
  public VMAP1PPOrchardA(IPolygon polygon, HashMap<String, Object> attributes,
