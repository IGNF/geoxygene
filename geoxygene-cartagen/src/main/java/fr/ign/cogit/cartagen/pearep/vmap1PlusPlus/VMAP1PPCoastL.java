...
public class VMAP1PPCoastL extends VMAP1PPFeature implements ICoastLine {
  ...
  private long acc, fcsubtype, keep, obj_rmq, slt, src_dim, src_name, upd_name,
      valid_stat, vdc, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPCoastL(ILineString lineString,
