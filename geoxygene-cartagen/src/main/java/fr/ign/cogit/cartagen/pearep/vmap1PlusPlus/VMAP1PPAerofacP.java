...
public class VMAP1PPAerofacP extends VMAPFeature implements IPointOfInterest {
  ...
  public VMAP1PPAerofacP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.iko_v2i = (String) attributes.get("iko_v2i");
    ...
    this.catair = (String) attributes.get("catair");
    this.src_info = (String) attributes.get("src_info");
