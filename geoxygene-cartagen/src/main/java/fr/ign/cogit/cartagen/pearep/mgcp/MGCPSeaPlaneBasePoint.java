...
public class MGCPSeaPlaneBasePoint extends MGCPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, iko, nam, src_date, src_info, tier_note,
      txt, uid, upd_date, upd_info, zva;
  private long acc, ace_eval, ale_eval, caa, cod, fun, smc, src_name, upd_name,
      zval_type;

  /**
   * @param type
   */
  public MGCPSeaPlaneBasePoint(IPoint point,
    ...
    this.cod = (Long) attributes.get("cod");
