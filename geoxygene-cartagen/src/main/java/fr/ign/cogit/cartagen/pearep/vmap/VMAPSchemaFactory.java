...
import fr.ign.cogit.cartagen.pearep.vmap.transport.VMAPRoadNode;
import fr.ign.cogit.geoxygene.contrib.cartetopo.Noeud;
import fr.ign.cogit.geoxygene.schemageo.api.support.reseau.Reseau;

public class VMAPSchemaFactory extends AbstractCreationFactory {

  @Override
  public IRoadNode createRoadNode(Noeud noeud) {
    return new VMAPRoadNode(noeud);
  }
