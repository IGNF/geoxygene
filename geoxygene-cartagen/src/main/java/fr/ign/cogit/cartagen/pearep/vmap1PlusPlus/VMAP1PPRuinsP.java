...
public class VMAP1PPRuinsP extends VMAP1PPFeature implements IBuildPoint {
  ...
  private long arh, fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPRuinsP(IPoint point, HashMap<String, Object> attributes,
