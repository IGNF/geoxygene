...
public class SHOMPebbleGravelArea extends SHOMFeature implements ISimpleLandUseArea {
   ...
   * @param type
   */
  public SHOMPebbleGravelArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
