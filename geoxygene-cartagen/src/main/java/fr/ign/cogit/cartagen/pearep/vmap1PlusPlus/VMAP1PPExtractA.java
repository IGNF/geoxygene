...
public class VMAP1PPExtractA extends VMAPFeature implements ISimpleLandUseArea {
   ...
   * @param type
   */
  public VMAP1PPExtractA(IPolygon polygon, HashMap<String, Object> attributes,
