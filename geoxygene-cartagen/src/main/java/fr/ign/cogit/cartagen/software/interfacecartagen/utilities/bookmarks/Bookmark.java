...
public class Bookmark {
   ...
   * @param name
   */
  Bookmark(String dataset,IEnvelope window,String name){
  ...
  public boolean equals(Object obj) {
    ...
    if(!this.datasetName.equals(other.datasetName)) return false;
    if(!this.extent.equals(other.extent)) return false;
    return true;
  }
   ...
   * @return
   */
  public double xLo(){return extent.getLowerCorner().getX();}
  
  /**
   * Get the high x coordinate of the extent of the bookmark.
   * @return
   */
  public double xHi(){return extent.getUpperCorner().getX();}
  
  /**
   * Get the low y coordinate of the extent of the bookmark.
   * @return
   */
  public double yLo(){return extent.getLowerCorner().getY();}
  
  /**
   * Get the high y coordinate of the extent of the bookmark.
   * @return
   */
  public double yHi(){return extent.getUpperCorner().getY();}
}
