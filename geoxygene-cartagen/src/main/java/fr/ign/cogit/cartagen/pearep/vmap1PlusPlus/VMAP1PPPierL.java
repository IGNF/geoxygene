...
public class VMAP1PPPierL extends VMAP1PPFeature implements IMiscLine {
  ...
  private long fcsubtype, keep, len_, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal, wid;

  /**
   * @param type
   */
  public VMAP1PPPierL(ILineString lineString,
