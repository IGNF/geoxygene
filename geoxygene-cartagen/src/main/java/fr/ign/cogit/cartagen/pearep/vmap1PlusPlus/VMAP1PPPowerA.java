...
public class VMAP1PPPowerA extends VMAP1PPFeature implements IPowerStationArea {
  ...
  private long fcsubtype, keep, obj_rmq, ppc, src_dim, src_name, upd_name,
   ...
   * @param type
   */
  public VMAP1PPPowerA(IPolygon polygon, HashMap<String, Object> attributes,
