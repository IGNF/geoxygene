...
public class VMAP1PPTreesA extends VMAP1PPFeature implements ISimpleLandUseArea {
  ...
  private long dmt, fcsubtype, keep, pht, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal, veg;
  private double area;

  /**
   * @param type
   */
  public VMAP1PPTreesA(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.dmt = getLongAttribute("dmt");
    this.pht = getLongAttribute("pht");
