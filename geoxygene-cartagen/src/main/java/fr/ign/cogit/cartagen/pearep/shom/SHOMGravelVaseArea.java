...
public class SHOMGravelVaseArea extends SHOMFeature implements ISimpleLandUseArea {

  // VMAP attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMGravelVaseArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMGravelVaseArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
