...
public class VMAP1PPCropA extends VMAP1PPFeature implements ISimpleLandUseArea {
  ...
  private long fcsubtype, ftc, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, veg, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPCropA(IPolygon polygon, HashMap<String, Object> attributes,
