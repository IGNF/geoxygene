...
public class VMAP1PPLndfrm1A extends VMAPFeature implements IReliefElementArea {
  ...
  private long feo, fcsubtype, keep, obj_rmq, ssc, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPLndfrm1A(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.feo = (Integer) attributes.get("feo");
