...
public class MGCPSoilSurfaceArea extends MGCPFeature implements
    ISimpleLandUseArea {
  ...
  private String ace, ale, cpyrt_note, date_bdi, nam, nfi, nfn, src_date,
      ...
      upd_info;
  private long acc, ace_eval, ale_eval, fcsubtype, smc, src_name, srd, swc,
      upd_name, valid_stat, zval_type, originform, targetscal;
  private double area;

  public MGCPSoilSurfaceArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public MGCPSoilSurfaceArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
    ...
    this.srd = getLongAttribute("srd");
    this.swc = getLongAttribute("swc");
