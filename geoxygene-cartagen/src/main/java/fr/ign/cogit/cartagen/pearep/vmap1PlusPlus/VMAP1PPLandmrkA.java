...
public class VMAP1PPLandmrkA extends VMAP1PPFeature implements IMiscArea {
  ...
  private long fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name, use_,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPLandmrkA(IPolygon polygon, HashMap<String, Object> attributes,
