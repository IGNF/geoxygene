...
public class VMAP1PPAgristrP extends VMAP1PPFeature implements IPointOfInterest {
  ...
  private String date_bdi, f_code, gfid_v2i, src_date, src_info, txt, uid_,
      ...
      natcon, prodct, status;
  private long exs, fcsubtype, hgt, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, zv2, scamax, scamin, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPAgristrP(IPoint point, HashMap<String, Object> attributes,
