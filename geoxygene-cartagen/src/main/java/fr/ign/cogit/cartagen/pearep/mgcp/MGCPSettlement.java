...
public class MGCPSettlement extends MGCPFeature implements ITown {
  ...
  private long acc, ace_eval, ale_eval, fuc, rel, src_name, upd_name,
      zval_type;

  /**
   * @param type
   */
  public MGCPSettlement(IPolygon polygon, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
