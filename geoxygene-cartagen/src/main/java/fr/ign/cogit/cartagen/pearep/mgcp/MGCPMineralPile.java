...
public class MGCPMineralPile extends MGCPFeature implements IBoundedArea {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, hgt, len, nam, src_date, src_info,
      tier_note, txt, uid, upd_date, upd_info, voi;
  private long acc, ace_eval, ale_eval, ppo, src_name, upd_name, zval_type;

  /**
   * @param type
   */
  public MGCPMineralPile(IPolygon polygon, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
