...
public class VMAP1PPDangerA extends VMAPFeature implements IMiscArea {
   ...
   * @param type
   */
  public VMAP1PPDangerA(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.setCod((Integer) attributes.get("cod"));
