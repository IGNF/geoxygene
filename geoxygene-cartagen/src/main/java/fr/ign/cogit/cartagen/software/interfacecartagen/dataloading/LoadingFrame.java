...
public class LoadingFrame extends JFrame implements ActionListener {
  ...
  public void initFrame() {
    ...
    this.leftListPanel.setBorder(BorderFactory
        .createTitledBorder("Original layers"));
    ...
    this.rightListPanel.setBorder(BorderFactory
        .createTitledBorder("Corresponding layers"));
    ...
    this.rightListPanel
        .add(new JLabel(
            "<html><h2><i color='#084B8A'>Dataset being processed : "
                + new File(this.dataSet).getName()
                + "</i></h2>"
    ...
    this.commandSubPanel.add(this.other = new JButton("Other dataset"));
  ...
  public void actionPerformed(ActionEvent ev) {
    ...
    if (src == this.other) {
      ...
      CartagenApplication.getInstance().getFrameChargeur().setVisible(true);
    }
