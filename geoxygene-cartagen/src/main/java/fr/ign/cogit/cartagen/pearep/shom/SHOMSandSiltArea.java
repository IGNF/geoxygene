...
public class SHOMSandSiltArea extends SHOMFeature implements ISimpleLandUseArea {

  // VMAP attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMSandSiltArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMSandSiltArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
