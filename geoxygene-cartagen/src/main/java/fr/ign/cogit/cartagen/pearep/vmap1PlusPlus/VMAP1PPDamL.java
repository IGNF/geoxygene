...
public class VMAP1PPDamL extends VMAP1PPFeature implements IBridgeLine {
  ...
  private String date_bdi, f_code, gfid_v2i, v2i_nam, ohb, src_date, src_info,
      txt, uid_, upd_date, upd_info, v2i_f_code, valid_date, valid_info, nam,
      catdam;
  private long fcsubtype, keep, len_, mcc, obj_rmq, src_dim, src_name, tuc,
      upd_name, valid_stat, zv2, scamax, scamin, originform, targetscal, hgt,
      exs;

  /**
   * @param type
   */
  public VMAP1PPDamL(ILineString lineString,
