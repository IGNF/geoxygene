...
public class SHOMRockArea extends SHOMFeature implements ISimpleLandUseArea {

  // attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMRockArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMRockArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
