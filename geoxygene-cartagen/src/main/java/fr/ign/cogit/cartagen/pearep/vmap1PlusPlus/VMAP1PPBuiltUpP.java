...
public class VMAP1PPBuiltUpP extends VMAPFeature implements IBuildPoint {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String date_bdi, f_code, gfid_v2i, src_date, src_info, txt, uid_,
      upd_date, upd_info, v2i_f_code, valid_date, valid_info, nam, catbua;
  private long arh, exs, fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, scamax, scamin, hgt, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPBuiltUpP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.src_info = (String) attributes.get("src_info");
    this.catbua = (String) attributes.get("catbua");
  ...
  public String getCatbua() {
    return catbua;
  }

  public void setCatbua(String catbua) {
    this.catbua = catbua;
  }
