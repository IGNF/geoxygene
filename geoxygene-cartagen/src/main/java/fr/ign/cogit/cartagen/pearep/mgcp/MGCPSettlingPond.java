...
public class MGCPSettlingPond extends MGCPFeature implements IWaterBasin {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, len, nam, src_date, src_info, tier_note,
   ...
   * @param type
   */
  public MGCPSettlingPond(IPolygon polygon, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
