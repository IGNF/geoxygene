...
public class VMAP1PPBridgeC extends VMAPFeature implements IBridgePoint {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String cla, date_bdi, f_code, gfid_v2i, len_, v2i_nam, ohb, src_date,
      src_info, txt, uid_, upd_date, upd_info, v2i_f_code, valid_date,
      valid_info, wd1, nam, catbrg, natcon, prodct;
  private long bdc, bot, bsc, exs, fcsubtype, hgt, keep, obj_rmq, src_dim,
   ...
   * @param type
   */
  public VMAP1PPBridgeC(IPoint point, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
    ...
    this.len_ = (String) attributes.get("len_");
    ...
    this.bdc = (Integer) attributes.get("bdc");
    this.bot = (Integer) attributes.get("bot");
    this.bsc = (Integer) attributes.get("bsc");
  ...
  public String getLen_() {
    return len_;
  }

  public void setLen_(String len_) {
    this.len_ = len_;
  }
