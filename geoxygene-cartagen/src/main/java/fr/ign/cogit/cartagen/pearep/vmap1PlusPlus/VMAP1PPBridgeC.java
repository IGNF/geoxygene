...
public class VMAP1PPBridgeC extends VMAP1PPFeature implements IBridgePoint {
  ...
  public VMAP1PPBridgeC(IPoint point, HashMap<String, Object> attributes,
    ...
    this.src_info = getStringAttribute("src_info");
    this.cla = getStringAttribute("cla");
    this.len_ = getStringAttribute("len_");
    this.v2i_nam = getStringAttribute("v2i_nam");
    this.ohb = getStringAttribute("ohb");
    this.wd1 = getStringAttribute("wd1");
    this.catbrg = getStringAttribute("catbrg");
