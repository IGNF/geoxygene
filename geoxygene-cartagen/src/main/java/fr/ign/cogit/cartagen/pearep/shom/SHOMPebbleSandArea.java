...
public class SHOMPebbleSandArea extends SHOMFeature implements ISimpleLandUseArea {

  // VMAP attributes
  private String typevale, ref_bdss;
  private double codesed, area;

  public SHOMPebbleSandArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public SHOMPebbleSandArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
