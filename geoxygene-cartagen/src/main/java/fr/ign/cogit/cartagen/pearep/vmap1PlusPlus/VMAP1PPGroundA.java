...
public class VMAP1PPGroundA extends VMAPFeature implements ISimpleLandUseArea {
  ...
  private long exs, fcsubtype, keep, mcc, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, scamax, scamin, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPGroundA(IPolygon polygon, HashMap<String, Object> attributes,
