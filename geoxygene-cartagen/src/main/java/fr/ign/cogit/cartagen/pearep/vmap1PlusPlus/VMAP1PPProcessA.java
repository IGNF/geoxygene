...
public class VMAP1PPProcessA extends VMAP1PPFeature implements IMiscArea {
  ...
  private long fcsubtype, keep, obj_rmq, pro, src_dim, src_name, upd_name,
   ...
   * @param type
   */
  public VMAP1PPProcessA(IPolygon polygon, HashMap<String, Object> attributes,
