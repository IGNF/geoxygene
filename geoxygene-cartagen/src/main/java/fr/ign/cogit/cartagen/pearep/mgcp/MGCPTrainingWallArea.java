...
public class MGCPTrainingWallArea extends MGCPFeature implements
    ITrainingWallArea {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, len, src_date, src_info, tier_note, txt,
      uid, upd_date, upd_info, wid;
  private long acc, ace_eval, ale_eval, src_name, upd_name, zval_type;

  /**
   * @param type
   */
  public MGCPTrainingWallArea(IPolygon polygon,
