...
public class MGCPCommunicationStationPoint extends MGCPFeature implements
    IMiscPoint {
  ...
  private long acc, ace_eval, ale_eval, awp, fun, loc, nst, src_name, smc, tos,
      upd_name, zval_type;

  /**
   * @param type
   */
  public MGCPCommunicationStationPoint(IPoint point,
