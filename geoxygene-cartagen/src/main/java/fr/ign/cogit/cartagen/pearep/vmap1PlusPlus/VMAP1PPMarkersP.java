...
public class VMAP1PPMarkersP extends VMAP1PPFeature implements IMiscPoint {
  ...
  private long cpa, fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, zv2, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPMarkersP(IPoint point, HashMap<String, Object> attributes,
