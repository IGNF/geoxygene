...
public class VMAP1PPWatrcrsL extends VMAP1PPFeature implements IWaterLine {
  ...
  private long exs, fcsubtype, hyc, keep, obj_rmq, src_dim, src_name, tid,
      upd_name, valid_stat, wid, originform, targetscal, scamax, scamin,
      catcan;
