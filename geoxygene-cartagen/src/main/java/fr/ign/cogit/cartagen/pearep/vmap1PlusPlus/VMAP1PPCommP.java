...
public class VMAP1PPCommP extends VMAP1PPFeature implements IMiscPoint {
  ...
  private long exs, fcsubtype, hgt, keep, nst, obj_rmq, src_dim, src_name, ssc,
      upd_name, valid_stat, zv2, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPCommP(IPoint point, HashMap<String, Object> attributes,
