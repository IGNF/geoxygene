...
public class VMAP1PPDangerP extends VMAPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String date_bdi, f_code, gfid_v2i, src_date, src_info, txt, uid_,
      upd_date, upd_info, v2i_f_code, valid_date, valid_info, nam, catwrk,
      status;
  private long arh, fcsubtype, keep, loc, mcc, obj_rmq, src_dim, src_name,
      upd_name, valid_stat, vrr, scamax, scamin, originform, targetscal,
      v2i_acc;

  /**
   * @param type
   */
  public VMAP1PPDangerP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.catwrk = (String) attributes.get("catwrk");
    ...
    this.arh = (Integer) attributes.get("arh");
    this.loc = (Integer) attributes.get("loc");
    this.mcc = (Integer) attributes.get("mcc");
    this.vrr = (Integer) attributes.get("vrr");
  ...
  public String getCatwrk() {
    return catwrk;
  }

  public void setCatwrk(String catwrk) {
    this.catwrk = catwrk;
  }
