...
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.bookmarks.BookmarkSet;
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.bookmarks.LoadBookmarkFrame;
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.selection.AttributeQueryAction;
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.selection.LoadObjectSelection;
import fr.ign.cogit.cartagen.software.interfacecartagen.utilities.selection.SaveObjectSelection;
...
public class UtilitiesGUIComponent extends JMenu {
  ...
  public UtilitiesGUIComponent(String title) {
    super(title);
    this.view = CartagenApplication.getInstance().getFrame().getVisuPanel();
    ...
    selectionMenu.add(new JMenuItem(new SaveObjectSelection()));
    selectionMenu.add(new JMenuItem(new LoadObjectSelection()));
  ...
  class InternationalisationAction extends AbstractAction {
    ...
    public InternationalisationAction() {
      putValue(Action.SHORT_DESCRIPTION, I18N
          .getString("MainLabels.changeLanguageDescr"));
  ...
  class ShowWktAction extends AbstractAction {
    ...
    public ShowWktAction() {
      putValue(Action.SHORT_DESCRIPTION, I18N
          .getString("Draw a WKT (String) geometry in the geometry pool"));
