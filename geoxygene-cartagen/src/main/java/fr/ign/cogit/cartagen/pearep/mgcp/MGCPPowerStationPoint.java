...
public class MGCPPowerStationPoint extends MGCPFeature implements
    IPowerStationPoint {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, ara, cpyrt_note, hgt, nam, nfi, nfn, len, src_date,
      src_info, tier_note, txt, uid, upd_date, upd_info, wid, voi;
  private long acc, ace_eval, ale_eval, fun, src_name, smc, upd_name,
      zval_type;

  /**
   * @param type
   */
  public MGCPPowerStationPoint(IPoint point,
    ...
    this.ara = (String) attributes.get("ara");
