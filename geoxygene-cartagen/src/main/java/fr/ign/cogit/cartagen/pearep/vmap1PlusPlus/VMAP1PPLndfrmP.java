...
public class VMAP1PPLndfrmP extends VMAPFeature implements IReliefElementPoint {
  ...
  private long fcsubtype, keep, mcc, obj_rmq, rkf, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPLndfrmP(IPoint point, HashMap<String, Object> attributes,
