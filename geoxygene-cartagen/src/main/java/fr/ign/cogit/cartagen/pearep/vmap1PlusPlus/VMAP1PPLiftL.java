...
public class VMAP1PPLiftL extends VMAP1PPFeature implements ICable {
  ...
  private long fcsubtype, hgt, keep, loc, obj_rmq, v2i_smc, src_dim, src_name,
      upd_name, use_, valid_stat, zv2, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPLiftL(ILineString lineString,
