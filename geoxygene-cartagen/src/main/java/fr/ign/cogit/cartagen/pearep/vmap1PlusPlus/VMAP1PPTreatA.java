...
public class VMAP1PPTreatA extends VMAP1PPFeature implements IWaterBasin {
  ...
  private long fcsubtype, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal, catmfa, scamax, scamin;
  private double area;

  /**
   * @param type
   */
  public VMAP1PPTreatA(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.catmfa = getLongAttribute("targetscal");
