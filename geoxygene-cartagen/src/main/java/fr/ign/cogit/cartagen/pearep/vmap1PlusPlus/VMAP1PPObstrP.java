...
public class VMAP1PPObstrP extends VMAP1PPFeature implements IMiscPoint {
  ...
  private long exs, fcsubtype, hgt, keep, loc, obj_rmq, src_dim, src_name,
      upd_name, valid_stat, zv2, originform, targetscal, scamax, scamin,
      catmfa, catcrn;
  private double lifcap, orient, radius;

  /**
   * @param type
   */
  public VMAP1PPObstrP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.catmfa = getLongAttribute("catmfa");
    this.catcrn = getLongAttribute("catcrn");

    this.lifcap = (Double) attributes.get("lifcap");
    this.orient = (Double) attributes.get("orient");
    this.radius = (Double) attributes.get("radius");
  ...
  public long getCatmfa() {
    return catmfa;
  }

  public void setCatmfa(long catmfa) {
    this.catmfa = catmfa;
  }

  public long getCatcrn() {
    return catcrn;
  }

  public void setCatcrn(long catcrn) {
    this.catcrn = catcrn;
  }

  public double getLifcap() {
    return lifcap;
  }

  public void setLifcap(double lifcap) {
    this.lifcap = lifcap;
  }
