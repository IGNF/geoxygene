...
public class VMAP1PPLndfrm2A extends VMAPFeature implements IReliefElementArea {
   ...
   * @param type
   */
  public VMAP1PPLndfrm2A(IPolygon polygon, HashMap<String, Object> attributes,
