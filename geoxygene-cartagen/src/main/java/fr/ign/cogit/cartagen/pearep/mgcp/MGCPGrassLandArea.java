...
public class MGCPGrassLandArea extends MGCPFeature implements
    ISimpleLandUseArea {
  ...
  private String ace, ale, cpyrt_note, date_bdi, dmt, nam, nfi, nfn, pfh,
      ...
      upd_date, upd_info;
  private long acc, ace_eval, ale_eval, fcsubtype, hrb, smc, src_name, tre,
      upd_name, valid_stat, veg, zval_type, originform, targetscal;
  private double area;

  public MGCPGrassLandArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public MGCPGrassLandArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
