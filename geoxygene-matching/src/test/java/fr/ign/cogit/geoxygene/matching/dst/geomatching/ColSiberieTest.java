...
public class ColSiberieTest {
  ...
  private final static Logger LOGGER = Logger.getLogger(ColSiberieTest.class);
  ...
  public void testAppriou1Critere() throws Exception {
    ...
    LOGGER.info("====================================================================================");
    LOGGER.info("Appariement Sibérie - 1 critère (géométrique)");
  ...
  public void testAppriou2Criteres() throws Exception {
    ...
    List<Source<IFeature, GeomHypothesis>> criteria = new ArrayList<Source<IFeature, GeomHypothesis>>();
    LOGGER.info("====================================================================================");
    LOGGER.info("Appariement Sibérie - 2 critère (géométrique + toponyme)");
    ...
    Assert.assertEquals(1, result.getValue(), 0.0001);
  ...
  public void testAppriou3Criteres() throws Exception {
    ...
    List<Source<IFeature, GeomHypothesis>> criteria = new ArrayList<Source<IFeature, GeomHypothesis>>();
    LOGGER.info("====================================================================================");
    LOGGER.info("Appariement Sibérie - 3 critères (géométrique + toponyme + wp)");
