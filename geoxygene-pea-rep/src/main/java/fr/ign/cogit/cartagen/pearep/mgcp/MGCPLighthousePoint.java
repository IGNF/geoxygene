...
public class MGCPLighthousePoint extends MGCPFeature implements IMiscPoint {

  private AutreConstruction geoxObj;

  // VMAP attributes
  private String ace, ale, cpyrt_note, nam, nfi, src_date, src_info, tier_note,
      txt, uid, upd_date, upd_info, voi;
  private long acc, ace_eval, ale_eval, cos, fun, smc, src_name, upd_name, vdc,
      zval_type;

  /**
   * @param type
   */
  public MGCPLighthousePoint(IPoint point, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
