...
public class VMAP1PPRoadL extends VMAP1PPFeature implements IRoadLine {
   ...
   * @param type
   */
  public VMAP1PPRoadL(ILineString lineString,
    ...
    this.ltn = getLongAttribute("ltn");
    this.med = getLongAttribute("med");
    this.rst = getLongAttribute("rst");
    this.rtt = getLongAttribute("rtt");
