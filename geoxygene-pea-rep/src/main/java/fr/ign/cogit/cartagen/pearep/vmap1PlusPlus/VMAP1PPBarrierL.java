...
public class VMAP1PPBarrierL extends VMAP1PPFeature implements IMiscLine {

  private AutreConstruction geoxObj;

  // VMAP1PlusPlus attributes
  private String date_bdi, f_code, gfid_v2i, nam, src_date, src_info, txt,
      uid_, upd_date, upd_info, v2i_f_code, valid_date, valid_info, natcon,
      status;
  private long exs, fcsubtype, hgt, keep, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, wid, originform, targetscal, scamax, scamin, catfnc;

  /**
   * @param type
   */
  public VMAP1PPBarrierL(ILineString lineString,
    ...
    this.catfnc = getLongAttribute("catfnc");
  ...
  public long getCatfnc() {
    return catfnc;
  }

  public void setCatfnc(long catfnc) {
    this.catfnc = catfnc;
  }
