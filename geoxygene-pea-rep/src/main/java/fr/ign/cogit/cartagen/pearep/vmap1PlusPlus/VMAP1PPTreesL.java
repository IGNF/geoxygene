...
public class VMAP1PPTreesL extends VMAP1PPFeature implements IMiscLine {
  ...
  private long fcsubtype, keep, pht, sbc, obj_rmq, src_dim, src_name, upd_name,
      valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPTreesL(ILineString lineString,
