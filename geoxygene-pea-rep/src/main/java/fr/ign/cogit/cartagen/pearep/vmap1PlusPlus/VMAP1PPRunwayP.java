...
public class VMAP1PPRunwayP extends VMAP1PPFeature implements IRunwayPoint {
  ...
  private long aoo, exs, fcsubtype, keep, len_, rst, obj_rmq, v2i_smc, src_dim,
      src_name, use_v2i, zv3, upd_name, valid_stat, originform, targetscal;

  /**
   * @param type
   */
  public VMAP1PPRunwayP(IPoint point, HashMap<String, Object> attributes,
    ...
    this.use_v2i = getLongAttribute("use_v2i");
  ...
  public long getUse_v2i() {
    return use_v2i;
  }

  public void setUse_v2i(long use_v2i) {
    this.use_v2i = use_v2i;
  }
