...
public class VMAP1PPTowerP extends VMAP1PPFeature implements IBuildPoint {
  ...
  private long exs, fcsubtype, hgt, keep, obj_rmq, src_dim, src_name, ttc,
      upd_name, valid_stat, originform, targetscal, zv2;

  /**
   * @param type
   */
  public VMAP1PPTowerP(IPoint point, HashMap<String, Object> attributes,
