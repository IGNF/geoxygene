...
public class MGCPShipWreckArea extends MGCPFeature implements IMiscArea {
  ...
  public MGCPShipWreckArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public MGCPShipWreckArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    super();
    this.setGeom(poly);
    this.setInitialGeom(poly);
