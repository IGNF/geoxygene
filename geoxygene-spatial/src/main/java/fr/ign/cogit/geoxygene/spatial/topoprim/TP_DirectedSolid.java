...
/**
 * Solide topologique orienté. Supporte la classe TP_Solid pour les
 * TP_Expression. Dans notre implémentation, l'identifiant d'un TP_DirectedTopo
 * est celui de sa primitive avec le signe de l'orientation. EXPLIQUER QUE C'EST
 * PAS PERISTANT et que A PRIORI ca n'a pas de GEOMETRIE
 * 
