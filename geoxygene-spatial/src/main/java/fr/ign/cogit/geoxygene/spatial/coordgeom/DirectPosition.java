...
public class DirectPosition implements IDirectPosition {
  ...
  public double distance(final IDirectPosition d) {
    if (!Double.isNaN(this.getZ()) && !Double.isNaN(d.getZ())
        && !Double.isInfinite(this.getZ()) && !Double.isInfinite(d.getZ())) {
  ...
  public int hashCode() {
    if (this.coordinate.length == 2) {
      return Double.valueOf(this.getX()).hashCode()
          ^ Double.valueOf(this.getY()).hashCode();
    }
    return Double.valueOf(this.getX()).hashCode()
        ^ Double.valueOf(this.getY()).hashCode()
        ^ Double.valueOf(this.getZ()).hashCode();
  }
}
