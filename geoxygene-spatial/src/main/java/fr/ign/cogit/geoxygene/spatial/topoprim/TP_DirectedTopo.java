...
/**
 * Classe mère abstraite pour les primitives topologiques orientées. Dans notre
 * implémentation 2 TP_DirectedTopo opposés ont des identifiants opposés. Bien
 * expliquer que dans la norme, ca n'herite pas de TP_Primitive, mais on a fait
 * ça à cause du double heritage (heritage fictif)
 * 
...
abstract public class TP_DirectedTopo extends TP_Primitive {
  ...
  /**
   * Crée un TP_Expression à partir de self. Sert de constructeur pour les
   * TP_Expression.
   */
  ...
  // / cette methodes sont definies dans les sous-classes avec un bon typage en
  // sortie //
  // ////////////////////////////////////////////////////////////////////////////////////
