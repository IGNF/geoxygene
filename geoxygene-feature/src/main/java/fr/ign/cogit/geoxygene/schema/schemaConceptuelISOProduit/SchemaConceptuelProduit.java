...
public class SchemaConceptuelProduit
        implements
        ProductConceptualSchema<FeatureType, AttributeType, FeatureAttributeValue, AssociationType, AssociationRole, InheritanceRelation> {
    /**
