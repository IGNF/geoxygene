...
/** Cette classe représente une relation dans le schéma HBDS de la BDCarto.
...
public abstract class PassePar extends ElementBDCarto {
	...
	/** Franchissement concerné par la relation.
	 *
	 *  Les methodes ...ID sont utiles uniquement au mapping et ne doivent pas être utilisées
	 *
	 *  NB : si il n'y a pas d'objet en relation, getObjet renvoie null.
	...
	/** Récupère le franchissement en relation. */
	public Franchissement getFranchissement() {return franchissement;  }
	/** Définit le franchissement en relation, et met à jour la relation inverse. */
