...
public class AppariementReseau1Process implements GeoServerProcess {
    
    /** LOGGER. */
    private final static Logger LOGGER = Logger.getLogger(AppariementReseau1Process.class.getName());
